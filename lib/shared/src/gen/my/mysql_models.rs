...
impl Channel {
    pub async fn replace(&self, pool: &Pool) -> Result<Channel,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel (channel_cid, pb_data) VALUES (?, ?)";
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel SET pb_data = ? WHERE channel_cid = ? ";
        let p = Params::Positional(vec![self.pb_data.clone().into(),  self.channel_cid.clone().into() ]);
...
impl ChannelFollower {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelFollower,MyError> {
        ...
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.profile_cid.clone().into(), self.follow_gid.clone().into()]);
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelFollower,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel_follower (channel_cid, profile_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.profile_cid.clone().into(), self.follow_gid.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.follow_gid.clone().into(),  self.profile_cid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.channel_follower WHERE channel_cid = ? AND profile_cid = ? ";
...
impl ChannelMsg {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelMsg,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel_msg (channel_cid, msg_gid, pb_data) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.msg_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel_msg SET pb_data = ? WHERE channel_cid = ? AND msg_gid = ? ";
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.pb_data.clone().into(),  self.msg_gid.clone().into() ]);
...
impl Chat {
    pub async fn replace(&self, pool: &Pool) -> Result<Chat,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.chat (profile_cid, chat_gid, pb_data) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.chat_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.chat SET pb_data = ? WHERE profile_cid = ? AND chat_gid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.pb_data.clone().into(),  self.chat_gid.clone().into() ]);
...
impl ChatMsg {
    pub async fn replace(&self, pool: &Pool) -> Result<ChatMsg,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.chat_msg (profile_cid, chat_gid, msg_gid, pb_data) VALUES (?, ?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.chat_gid.clone().into(), self.msg_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.chat_msg SET pb_data = ? WHERE profile_cid = ? AND chat_gid = ? AND msg_gid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.chat_gid.clone().into(), self.pb_data.clone().into(),  self.msg_gid.clone().into() ]);
...
impl Direct {
    pub async fn replace(&self, pool: &Pool) -> Result<Direct,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.direct (profile_cid, direct_gid, msg_gid, pb_data) VALUES (?, ?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.direct_gid.clone().into(), self.msg_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.direct SET pb_data = ? WHERE profile_cid = ? AND direct_gid = ? AND msg_gid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.direct_gid.clone().into(), self.pb_data.clone().into(),  self.msg_gid.clone().into() ]);
...
impl File {
    pub async fn replace(&self, pool: &Pool) -> Result<File,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.file (file_gid, pb_data) VALUES (?, ?)";
        let p = Params::Positional(vec![self.file_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.file SET pb_data = ? WHERE file_gid = ? ";
        let p = Params::Positional(vec![self.pb_data.clone().into(),  self.file_gid.clone().into() ]);
...
impl FromRow for MsgComment {
        ...
        Self: Sized,
    {
        Ok(MsgComment  {
            ...
            comment_gid: row.get(1).unwrap_or_default(),
            pb_data: row.get(2).unwrap_or_default(),
        })
    }
}
...
impl MsgComment {
    pub async fn replace(&self, pool: &Pool) -> Result<MsgComment,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.msg_comment (message_gid, comment_gid, pb_data) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.comment_gid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.msg_comment SET pb_data = ? WHERE message_gid = ? AND comment_gid = ? ";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.pb_data.clone().into(),  self.comment_gid.clone().into() ]);
...
impl MsgLikeSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<MsgLike>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl Profile {
    pub async fn replace(&self, pool: &Pool) -> Result<Profile,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.profile (profile_cid, pb_data) VALUES (?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.profile SET pb_data = ? WHERE profile_cid = ? ";
        let p = Params::Positional(vec![self.pb_data.clone().into(),  self.profile_cid.clone().into() ]);
...
impl Sms {
    pub async fn insert(&self, pool: &Pool) -> Result<Sms,MyError> {
        ...
        let p = Params::Positional(vec![self.phone_number.clone().into(), self.hash_code.clone().into(), self.result_code.clone().into(), self.pd_data.clone().into(), self.json_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.phone_number.clone().into(), self.hash_code.clone().into(), self.result_code.clone().into(), self.pd_data.clone().into(), self.json_data.clone().into(),  self.sms_id.clone().into() ]);
...
impl SmsSelector {
    ...
    pub fn select_json_data(&mut self) -> &mut Self {
        self.select_cols.push("json_data");
        self
    }
    ...
    pub fn order_by_json_data_asc(&mut self) -> &mut Self {
		self.order_by.push("json_data ASC");
        self
    }

	pub fn order_by_json_data_desc(&mut self) -> &mut Self {
		self.order_by.push("json_data DESC");
        self
    }
    ...
    pub fn json_data_eq (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: " json_data = ?".to_string(),
            args: val.into(),
        };
        self.wheres.push(w);
        self
    ...
    pub fn json_data_lt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: " json_data < ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn json_data_le (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: " json_data <= ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn json_data_gt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: " json_data > ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn json_data_ge (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: " json_data >= ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn and_json_data_eq (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "AND json_data = ?".to_string(),
            args: val.into(),
        };
        self.wheres.push(w);
        self
    ...
    pub fn and_json_data_lt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "AND json_data < ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn and_json_data_le (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "AND json_data <= ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn and_json_data_gt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "AND json_data > ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn and_json_data_ge (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "AND json_data >= ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn or_json_data_eq (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "OR json_data = ?".to_string(),
            args: val.into(),
        };
        self.wheres.push(w);
        self
    ...
    pub fn or_json_data_lt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "OR json_data < ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn or_json_data_le (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "OR json_data <= ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn or_json_data_gt (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "OR json_data > ?".to_string(),
            args: val.into(),
        };
    ...
    pub fn or_json_data_ge (&mut self, val: &str ) -> &mut Self {
        let w = WhereClause{
            condition: "OR json_data >= ?".to_string(),
            args: val.into(),
        };
...
impl User {
    pub async fn replace(&self, pool: &Pool) -> Result<User,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.user (user_cid, pb_data) VALUES (?, ?)";
        let p = Params::Positional(vec![self.user_cid.clone().into(), self.pb_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.user SET pb_data = ? WHERE user_cid = ? ";
        let p = Params::Positional(vec![self.pb_data.clone().into(),  self.user_cid.clone().into() ]);
