...
impl ChannelFollower {
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelFollower, MyError> {
        ...
        let query =
            r"REPLACE INTO flip_my.channel_follower (profile_cid, channel_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![
            self.profile_cid.clone().into(),
            self.channel_cid.clone().into(),
            self.created_time.clone().into(),
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(), MyError> {
        ...
        let query =
            r"DELETE FROM flip_my.channel_follower WHERE profile_cid = ? AND channel_cid = ? ";
        let p = Params::Positional(vec![self.channel_cid.clone().into()]);
...
#[derive(Debug, PartialEq, Eq, Clone)]
pub struct ChannelMessageLike {
    // channel_message_like
    pub message_gid: u64,
    pub profile_cid: u64,
}
...
impl ChannelMessageLike {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelMessageLike, MyError> {
        ...
        let query =
            r"REPLACE INTO flip_my.channel_message_like (message_gid, profile_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(), MyError> {
        let mut conn = pool.get_conn().await?;
        let query =
            r"UPDATE flip_my.channel_message_like SET  WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![
            self.message_gid.clone().into(),
            self.profile_cid.clone().into(),
        ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(), MyError> {
        ...
        let query =
            r"DELETE FROM flip_my.channel_message_like WHERE message_gid = ? AND profile_cid = ? ";
...
impl ChannelMessageLikeSelector {
    ...
    pub async fn _get_rows_with_size(
        ...
        session: &Pool,
        size: i64,
    ) -> Result<Vec<ChannelMessageLike>, MyError> {
        let mut conn = session.get_conn().await?;
        let (cql_query, query_values) = self._to_cql();
        ...
        let query_result = conn
            .exec_map(cql_query, p, |obj: ChannelMessageLike| obj)
            .await?;
...
impl ChannelMsgLike {
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelMsgLike, MyError> {
        ...
        let query =
            r"REPLACE INTO flip_my.channel_msg_like (message_gid, profile_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![
            self.message_gid.clone().into(),
            self.profile_cid.clone().into(),
            self.created_time.clone().into(),
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(), MyError> {
        ...
        let query =
            r"DELETE FROM flip_my.channel_msg_like WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into()]);
...
impl ChannelMsgLikeSelector {
    ...
    pub async fn _get_rows_with_size(
        ...
        session: &Pool,
        size: i64,
    ) -> Result<Vec<ChannelMsgLike>, MyError> {
        let mut conn = session.get_conn().await?;
        let (cql_query, query_values) = self._to_cql();
        ...
        let query_result = conn
            .exec_map(cql_query, p, |obj: ChannelMsgLike| obj)
            .await?;
...
impl MsgLike2Selector {
    ...
    pub async fn _get_rows_with_size(
        ...
        let query_result = conn.exec_map(cql_query, p, |obj: MsgLike2| obj).await?;
