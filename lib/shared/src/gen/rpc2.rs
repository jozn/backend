...
pub trait IPC_CMaster_Handler {
    async fn GetNextId(up: &UserParam, param: pb::GetNextIdParam) -> Result<pb::GetNextIdResponse, GenErr> {
        Ok(pb::GetNextIdResponse::default())
    }
}
#[async_trait]
pub trait RPC_Auth_Handler {
    async fn AuthSendCode(up: &UserParam, param: pb::AuthSendCodeParam) -> Result<pb::AuthSendCodeResponse, GenErr> {
        Ok(pb::AuthSendCodeResponse::default())
    }
    async fn AuthLogIn(up: &UserParam, param: pb::AuthLogInParam) -> Result<pb::AuthLogInResponse, GenErr> {
        Ok(pb::AuthLogInResponse::default())
    }
    async fn AuthLogOut(up: &UserParam, param: pb::AuthLogOutParam) -> Result<pb::AuthLogOutResponse, GenErr> {
        Ok(pb::AuthLogOutResponse::default())
    }
}
#[async_trait]
pub trait RPC_Channel_Handler {
    async fn ChannelCreateChannel(up: &UserParam, param: pb::ChannelCreateChannelParam) -> Result<pb::ChannelCreateChannelResponse, GenErr> {
        Ok(pb::ChannelCreateChannelResponse::default())
    }
    async fn ChannelEditChannel(up: &UserParam, param: pb::ChannelEditChannelParam) -> Result<pb::ChannelEditChannelResponse, GenErr> {
        Ok(pb::ChannelEditChannelResponse::default())
    }
    async fn ChannelDeleteChannel(up: &UserParam, param: pb::ChannelDeleteChannelParam) -> Result<pb::ChannelDeleteChannelResponse, GenErr> {
        Ok(pb::ChannelDeleteChannelResponse::default())
    }
    async fn ChannelAddAuthor(up: &UserParam, param: pb::ChannelAddAuthorParam) -> Result<pb::ChannelAddAuthorResponse, GenErr> {
        Ok(pb::ChannelAddAuthorResponse::default())
    }
    async fn ChannelChangeAuthorPermission(up: &UserParam, param: pb::ChannelChangeAuthorPermissionParam) -> Result<pb::ChannelChangeAuthorPermissionResponse, GenErr> {
        Ok(pb::ChannelChangeAuthorPermissionResponse::default())
    }
    async fn ChannelRemoveAuthor(up: &UserParam, param: pb::ChannelRemoveAuthorParam) -> Result<pb::ChannelRemoveAuthorResponse, GenErr> {
        Ok(pb::ChannelRemoveAuthorResponse::default())
    }
    async fn ChannelFollowChannel(up: &UserParam, param: pb::ChannelFollowChannelParam) -> Result<pb::ChannelFollowChannelResponse, GenErr> {
        Ok(pb::ChannelFollowChannelResponse::default())
    }
    async fn ChannelUnFollowChannel(up: &UserParam, param: pb::ChannelUnFollowChannelParam) -> Result<pb::ChannelUnFollowChannelResponse, GenErr> {
        Ok(pb::ChannelUnFollowChannelResponse::default())
    }
    async fn ChannelRemoveFollowers(up: &UserParam, param: pb::ChannelRemoveFollowersParam) -> Result<pb::ChannelRemoveFollowersResponse, GenErr> {
        Ok(pb::ChannelRemoveFollowersResponse::default())
    }
    async fn ChannelSubscribe(up: &UserParam, param: pb::ChannelSubscribeParam) -> Result<pb::ChannelSubscribeResponse, GenErr> {
        Ok(pb::ChannelSubscribeResponse::default())
    }
    async fn ChannelUnSubscribe(up: &UserParam, param: pb::ChannelUnSubscribeParam) -> Result<pb::ChannelUnSubscribeResponse, GenErr> {
        Ok(pb::ChannelUnSubscribeResponse::default())
    }
    async fn ChannelRemoveSubscribers(up: &UserParam, param: pb::ChannelRemoveSubscribersParam) -> Result<pb::ChannelRemoveSubscribersResponse, GenErr> {
        Ok(pb::ChannelRemoveSubscribersResponse::default())
    }
    async fn ChannelChangePrivacy(up: &UserParam, param: pb::ChannelChangePrivacyParam) -> Result<pb::ChannelChangePrivacyResponse, GenErr> {
        Ok(pb::ChannelChangePrivacyResponse::default())
    }
    async fn ChannelChangeDefaultPermission(up: &UserParam, param: pb::ChannelChangeDefaultPermissionParam) -> Result<pb::ChannelChangeDefaultPermissionResponse, GenErr> {
        Ok(pb::ChannelChangeDefaultPermissionResponse::default())
    }
    async fn ChannelRevokeLink(up: &UserParam, param: pb::ChannelRevokeLinkParam) -> Result<pb::ChannelRevokeLinkResponse, GenErr> {
        Ok(pb::ChannelRevokeLinkResponse::default())
    }
    async fn ChannelChangeUsername(up: &UserParam, param: pb::ChannelChangeUsernameParam) -> Result<pb::ChannelChangeUsernameResponse, GenErr> {
        Ok(pb::ChannelChangeUsernameResponse::default())
    }
    async fn ChannelBlockProfile(up: &UserParam, param: pb::ChannelBlockProfileParam) -> Result<pb::ChannelBlockProfileResponse, GenErr> {
        Ok(pb::ChannelBlockProfileResponse::default())
    }
    async fn ChannelSendMessage(up: &UserParam, param: pb::ChannelSendMessageParam) -> Result<pb::ChannelSendMessageResponse, GenErr> {
        Ok(pb::ChannelSendMessageResponse::default())
    }
    async fn ChannelEditMessage(up: &UserParam, param: pb::ChannelEditMessageParam) -> Result<pb::ChannelEditMessageResponse, GenErr> {
        Ok(pb::ChannelEditMessageResponse::default())
    }
    async fn ChannelDeleteMessages(up: &UserParam, param: pb::ChannelDeleteMessagesParam) -> Result<pb::ChannelDeleteMessagesResponse, GenErr> {
        Ok(pb::ChannelDeleteMessagesResponse::default())
    }
    async fn ChannelLikeMessage(up: &UserParam, param: pb::ChannelLikeMessageParam) -> Result<pb::ChannelLikeMessageResponse, GenErr> {
        Ok(pb::ChannelLikeMessageResponse::default())
    }
    async fn ChannelUnLikeMessage(up: &UserParam, param: pb::ChannelUnLikeMessageParam) -> Result<pb::ChannelUnLikeMessageResponse, GenErr> {
        Ok(pb::ChannelUnLikeMessageResponse::default())
    }
    async fn ChannelReShareMessage(up: &UserParam, param: pb::ChannelReShareMessageParam) -> Result<pb::ChannelReShareMessageResponse, GenErr> {
        Ok(pb::ChannelReShareMessageResponse::default())
    }
    async fn ChannelUnReShareMessage(up: &UserParam, param: pb::ChannelUnReShareMessageParam) -> Result<pb::ChannelUnReShareMessageResponse, GenErr> {
        Ok(pb::ChannelUnReShareMessageResponse::default())
    }
    async fn ChannelAddComment(up: &UserParam, param: pb::ChannelAddCommentParam) -> Result<pb::ChannelAddCommentResponse, GenErr> {
        Ok(pb::ChannelAddCommentResponse::default())
    }
    async fn ChannelDeleteComment(up: &UserParam, param: pb::ChannelDeleteCommentParam) -> Result<pb::ChannelDeleteCommentResponse, GenErr> {
        Ok(pb::ChannelDeleteCommentResponse::default())
    }
    async fn ChannelPinMessage(up: &UserParam, param: pb::ChannelPinMessageParam) -> Result<pb::ChannelPinMessageResponse, GenErr> {
        Ok(pb::ChannelPinMessageResponse::default())
    }
    async fn ChannelUnPinMessage(up: &UserParam, param: pb::ChannelUnPinMessageParam) -> Result<pb::ChannelUnPinMessageResponse, GenErr> {
        Ok(pb::ChannelUnPinMessageResponse::default())
    }
    async fn ChannelAvatarAdd(up: &UserParam, param: pb::ChannelAvatarAddParam) -> Result<pb::ChannelAvatarAddResponse, GenErr> {
        Ok(pb::ChannelAvatarAddResponse::default())
    }
    async fn ChannelAvatarDelete(up: &UserParam, param: pb::ChannelAvatarDeleteParam) -> Result<pb::ChannelAvatarDeleteResponse, GenErr> {
        Ok(pb::ChannelAvatarDeleteResponse::default())
    }
    async fn ChannelSendDoingAction(up: &UserParam, param: pb::ChannelSendDoingActionParam) -> Result<pb::ChannelSendDoingActionResponse, GenErr> {
        Ok(pb::ChannelSendDoingActionResponse::default())
    }
    async fn ChannelReportChannel(up: &UserParam, param: pb::ChannelReportChannelParam) -> Result<pb::ChannelReportChannelResponse, GenErr> {
        Ok(pb::ChannelReportChannelResponse::default())
    }
    async fn ChannelReportMessage(up: &UserParam, param: pb::ChannelReportMessageParam) -> Result<pb::ChannelReportMessageResponse, GenErr> {
        Ok(pb::ChannelReportMessageResponse::default())
    }
    async fn ChannelGetFull(up: &UserParam, param: pb::ChannelGetFullParam) -> Result<pb::ChannelGetFullResponse, GenErr> {
        Ok(pb::ChannelGetFullResponse::default())
    }
    async fn ChannelGetMessagesList(up: &UserParam, param: pb::ChannelGetMessagesListParam) -> Result<pb::ChannelGetMessagesListResponse, GenErr> {
        Ok(pb::ChannelGetMessagesListResponse::default())
    }
    async fn ChannelGetMediaList(up: &UserParam, param: pb::ChannelGetMediaListParam) -> Result<pb::ChannelGetMediaListResponse, GenErr> {
        Ok(pb::ChannelGetMediaListResponse::default())
    }
    async fn ChannelGetAuthors(up: &UserParam, param: pb::ChannelGetAuthorsParam) -> Result<pb::ChannelGetAuthorsResponse, GenErr> {
        Ok(pb::ChannelGetAuthorsResponse::default())
    }
    async fn ChannelGetFollowers(up: &UserParam, param: pb::ChannelGetFollowersParam) -> Result<pb::ChannelGetFollowersResponse, GenErr> {
        Ok(pb::ChannelGetFollowersResponse::default())
    }
    async fn ChannelGetSubscribers(up: &UserParam, param: pb::ChannelGetSubscribersParam) -> Result<pb::ChannelGetSubscribersResponse, GenErr> {
        Ok(pb::ChannelGetSubscribersResponse::default())
    }
    async fn ChannelBlocked(up: &UserParam, param: pb::ChannelBlockedParam) -> Result<pb::ChannelBlockedResponse, GenErr> {
        Ok(pb::ChannelBlockedResponse::default())
    }
    async fn ChannelAvatarGetList(up: &UserParam, param: pb::ChannelAvatarGetListParam) -> Result<pb::ChannelAvatarGetListResponse, GenErr> {
        Ok(pb::ChannelAvatarGetListResponse::default())
    }
    async fn ChannelGetInbox(up: &UserParam, param: pb::ChannelGetInboxParam) -> Result<pb::ChannelGetInboxResponse, GenErr> {
        Ok(pb::ChannelGetInboxResponse::default())
    }
    async fn ChannelGetFollowings(up: &UserParam, param: pb::ChannelGetFollowingsParam) -> Result<pb::ChannelGetFollowingsResponse, GenErr> {
        Ok(pb::ChannelGetFollowingsResponse::default())
    }
}
#[async_trait]
pub trait RPC_Chat_Handler {
    async fn ChatDeleteChat(up: &UserParam, param: pb::ChatDeleteChatParam) -> Result<pb::ChatDeleteChatResponse, GenErr> {
        Ok(pb::ChatDeleteChatResponse::default())
    }
    async fn ChatSendMessage(up: &UserParam, param: pb::ChatSendMessageParam) -> Result<pb::ChatSendMessageResponse, GenErr> {
        Ok(pb::ChatSendMessageResponse::default())
    }
    async fn ChatEditMessage(up: &UserParam, param: pb::ChatEditMessageParam) -> Result<pb::ChatEditMessageResponse, GenErr> {
        Ok(pb::ChatEditMessageResponse::default())
    }
    async fn ChatDeleteMessages(up: &UserParam, param: pb::ChatDeleteMessagesParam) -> Result<pb::ChatDeleteMessagesResponse, GenErr> {
        Ok(pb::ChatDeleteMessagesResponse::default())
    }
    async fn ChatDeleteHistory(up: &UserParam, param: pb::ChatDeleteHistoryParam) -> Result<pb::ChatDeleteHistoryResponse, GenErr> {
        Ok(pb::ChatDeleteHistoryResponse::default())
    }
    async fn ChatSetNotification(up: &UserParam, param: pb::ChatSetNotificationParam) -> Result<pb::ChatSetNotificationResponse, GenErr> {
        Ok(pb::ChatSetNotificationResponse::default())
    }
    async fn ChatSendDoingAction(up: &UserParam, param: pb::ChatSendDoingActionParam) -> Result<pb::ChatSendDoingActionResponse, GenErr> {
        Ok(pb::ChatSendDoingActionResponse::default())
    }
    async fn ChatReportChat(up: &UserParam, param: pb::ChatReportChatParam) -> Result<pb::ChatReportChatResponse, GenErr> {
        Ok(pb::ChatReportChatResponse::default())
    }
    async fn ChatGetFull(up: &UserParam, param: pb::ChatGetFullMessageParam) -> Result<pb::ChatGetFullMessageResponse, GenErr> {
        Ok(pb::ChatGetFullMessageResponse::default())
    }
    async fn ChatGetMessagesList(up: &UserParam, param: pb::ChatGetMessagesListParam) -> Result<pb::ChatGetMessagesListResponse, GenErr> {
        Ok(pb::ChatGetMessagesListResponse::default())
    }
    async fn ChatGetMediaList(up: &UserParam, param: pb::ChatGetMediaListParam) -> Result<pb::ChatGetMediaListResponse, GenErr> {
        Ok(pb::ChatGetMediaListResponse::default())
    }
    async fn ChatGetInbox(up: &UserParam, param: pb::ChatGetInboxParam) -> Result<pb::ChatGetInboxResponse, GenErr> {
        Ok(pb::ChatGetInboxResponse::default())
    }
}
#[async_trait]
pub trait RPC_Group_Handler {
    async fn GroupCreateGroup(up: &UserParam, param: pb::GroupCreateGroupParam) -> Result<pb::GroupCreateGroupResponse, GenErr> {
        Ok(pb::GroupCreateGroupResponse::default())
    }
    async fn GroupEditGroup(up: &UserParam, param: pb::GroupEditGroupParam) -> Result<pb::GroupEditGroupResponse, GenErr> {
        Ok(pb::GroupEditGroupResponse::default())
    }
    async fn GroupDeleteGroup(up: &UserParam, param: pb::GroupDeleteGroupParam) -> Result<pb::GroupDeleteGroupResponse, GenErr> {
        Ok(pb::GroupDeleteGroupResponse::default())
    }
    async fn GroupAddAdmin(up: &UserParam, param: pb::GroupAddAdminParam) -> Result<pb::GroupAddAdminResponse, GenErr> {
        Ok(pb::GroupAddAdminResponse::default())
    }
    async fn GroupRemoveMember(up: &UserParam, param: pb::GroupRemoveMemberParam) -> Result<pb::GroupRemoveMemberResponse, GenErr> {
        Ok(pb::GroupRemoveMemberResponse::default())
    }
    async fn GroupChangeMemberLevel(up: &UserParam, param: pb::GroupChangeMemberLevelParam) -> Result<pb::GroupChangeMemberLevelResponse, GenErr> {
        Ok(pb::GroupChangeMemberLevelResponse::default())
    }
    async fn GroupChangeMemberPermission(up: &UserParam, param: pb::GroupChangeMemberPermissionParam) -> Result<pb::GroupChangeMemberPermissionResponse, GenErr> {
        Ok(pb::GroupChangeMemberPermissionResponse::default())
    }
    async fn GroupBanMember(up: &UserParam, param: pb::GroupBanMemberParam) -> Result<pb::GroupBanMemberResponse, GenErr> {
        Ok(pb::GroupBanMemberResponse::default())
    }
    async fn GroupJoinGroup(up: &UserParam, param: pb::JoinGroupParam) -> Result<pb::JoinGroupResponse, GenErr> {
        Ok(pb::JoinGroupResponse::default())
    }
    async fn GroupLeaveGroup(up: &UserParam, param: pb::GroupLeaveGroupParam) -> Result<pb::GroupLeaveGroupResponse, GenErr> {
        Ok(pb::GroupLeaveGroupResponse::default())
    }
    async fn GroupAddMember(up: &UserParam, param: pb::GroupAddMemberParam) -> Result<pb::GroupAddMemberResponse, GenErr> {
        Ok(pb::GroupAddMemberResponse::default())
    }
    async fn GroupSetNotification(up: &UserParam, param: pb::GroupSetNotificationParam) -> Result<pb::GroupSetNotificationResponse, GenErr> {
        Ok(pb::GroupSetNotificationResponse::default())
    }
    async fn GroupChangePrivacy(up: &UserParam, param: pb::GroupChangePrivacyParam) -> Result<pb::GroupChangePrivacyResponse, GenErr> {
        Ok(pb::GroupChangePrivacyResponse::default())
    }
    async fn GroupChangeDefaultPermission(up: &UserParam, param: pb::GroupChangeDefaultPermissionParam) -> Result<pb::GroupChangeDefaultPermissionResponse, GenErr> {
        Ok(pb::GroupChangeDefaultPermissionResponse::default())
    }
    async fn GroupRevokeLink(up: &UserParam, param: pb::GroupRevokeLinkParam) -> Result<pb::GroupRevokeLinkResponse, GenErr> {
        Ok(pb::GroupRevokeLinkResponse::default())
    }
    async fn GroupChangeUsername(up: &UserParam, param: pb::GroupChangeUsernameParam) -> Result<pb::GroupChangeUsernameResponse, GenErr> {
        Ok(pb::GroupChangeUsernameResponse::default())
    }
    async fn GroupSendMessage(up: &UserParam, param: pb::GroupSendMessageParam) -> Result<pb::GroupSendMessageResponse, GenErr> {
        Ok(pb::GroupSendMessageResponse::default())
    }
    async fn GroupEditMessage(up: &UserParam, param: pb::GroupEditMessageParam) -> Result<pb::GroupEditMessageResponse, GenErr> {
        Ok(pb::GroupEditMessageResponse::default())
    }
    async fn GroupDeleteMessages(up: &UserParam, param: pb::GroupDeleteMessagesParam) -> Result<pb::GroupDeleteMessagesResponse, GenErr> {
        Ok(pb::GroupDeleteMessagesResponse::default())
    }
    async fn GroupDeleteHistory(up: &UserParam, param: pb::GroupDeleteHistoryParam) -> Result<pb::GroupDeleteHistoryResponse, GenErr> {
        Ok(pb::GroupDeleteHistoryResponse::default())
    }
    async fn GroupPinMessage(up: &UserParam, param: pb::GroupPinMessageParam) -> Result<pb::GroupPinMessageResponse, GenErr> {
        Ok(pb::GroupPinMessageResponse::default())
    }
    async fn GroupUnPinMessage(up: &UserParam, param: pb::GroupUnPinMessageParam) -> Result<pb::GroupUnPinMessageResponse, GenErr> {
        Ok(pb::GroupUnPinMessageResponse::default())
    }
    async fn GroupAvatarAdd(up: &UserParam, param: pb::GroupAvatarAddParam) -> Result<pb::GroupAvatarAddResponse, GenErr> {
        Ok(pb::GroupAvatarAddResponse::default())
    }
    async fn GroupAvatarDelete(up: &UserParam, param: pb::GroupAvatarDeleteParam) -> Result<pb::GroupAvatarDeleteResponse, GenErr> {
        Ok(pb::GroupAvatarDeleteResponse::default())
    }
    async fn GroupSendDoingAction(up: &UserParam, param: pb::GroupSendDoingActionParam) -> Result<pb::GroupSendDoingActionResponse, GenErr> {
        Ok(pb::GroupSendDoingActionResponse::default())
    }
    async fn GroupReportGroup(up: &UserParam, param: pb::GroupReportGroupParam) -> Result<pb::GroupReportGroupResponse, GenErr> {
        Ok(pb::GroupReportGroupResponse::default())
    }
    async fn GroupGetFull(up: &UserParam, param: pb::GroupGetFullParam) -> Result<pb::GroupGetFullResponse, GenErr> {
        Ok(pb::GroupGetFullResponse::default())
    }
    async fn GroupGetMessagesList(up: &UserParam, param: pb::GroupGetMessagesListParam) -> Result<pb::GroupGetMessagesListResponse, GenErr> {
        Ok(pb::GroupGetMessagesListResponse::default())
    }
    async fn GroupGetMediaList(up: &UserParam, param: pb::GroupGetMediaListParam) -> Result<pb::GroupGetMediaListResponse, GenErr> {
        Ok(pb::GroupGetMediaListResponse::default())
    }
    async fn GroupGetMembersList(up: &UserParam, param: pb::GroupGetMembersListParam) -> Result<pb::GroupGetMembersListResponse, GenErr> {
        Ok(pb::GroupGetMembersListResponse::default())
    }
    async fn GroupGetAdminsList(up: &UserParam, param: pb::GroupGetAdminsListParam) -> Result<pb::GroupGetAdminsListResponse, GenErr> {
        Ok(pb::GroupGetAdminsListResponse::default())
    }
    async fn GroupAvatarGetList(up: &UserParam, param: pb::GroupAvatarGetListParam) -> Result<pb::GroupAvatarGetListResponse, GenErr> {
        Ok(pb::GroupAvatarGetListResponse::default())
    }
    async fn GroupGetInbox(up: &UserParam, param: pb::GroupGetInboxParam) -> Result<pb::GroupGetInboxResponse, GenErr> {
        Ok(pb::GroupGetInboxResponse::default())
    }
}
#[async_trait]
pub trait RPC_Profile_Handler {
    async fn ProfileSetSettings(up: &UserParam, param: pb::ProfileSetSettingsParam) -> Result<pb::ProfileSetSettingsResponse, GenErr> {
        Ok(pb::ProfileSetSettingsResponse::default())
    }
}
#[async_trait]
pub trait RPC_Sample_Handler {
    async fn GetUsers1(up: &UserParam, param: pb::GetUsers1Param) -> Result<pb::GetUsers1Response, GenErr> {
        Ok(pb::GetUsers1Response::default())
    }
    async fn GetProfiles(up: &UserParam, param: pb::GetProfilesParam) -> Result<pb::GetProfilesResponse, GenErr> {
        Ok(pb::GetProfilesResponse::default())
    }
    async fn GetChannels(up: &UserParam, param: pb::GetChannelsParam) -> Result<pb::GetChannelsResponse, GenErr> {
        Ok(pb::GetChannelsResponse::default())
    }
    async fn GetDirects(up: &UserParam, param: pb::GetDirectsParam) -> Result<pb::GetDirectsResponse, GenErr> {
        Ok(pb::GetDirectsResponse::default())
    }
    async fn GetMessages(up: &UserParam, param: pb::GetMessagesParam) -> Result<pb::GetMessagesResponse, GenErr> {
        Ok(pb::GetMessagesResponse::default())
    }
}
#[async_trait]
pub trait RPC_Shared_Handler {
    async fn SharedEcho(up: &UserParam, param: pb::SharedEchoParam) -> Result<pb::SharedEchoResponse, GenErr> {
        Ok(pb::SharedEchoResponse::default())
    }
    async fn SharedCheckUserName(up: &UserParam, param: pb::SharedCheckUserNameParam) -> Result<pb::SharedCheckUserNameResponse, GenErr> {
...
pub trait RPC_Shop_Handler {
    ...
    async fn ShopAddProductToBasket(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
    async fn ShopRemoveProductFromBasket(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
    ...
    async fn ShopGetLikedProductsList(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
    async fn ShopGetLikedShopsList(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
    ...
    async fn ShopEditProductPrice(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
    async fn ShopEditProductInventory(up: &UserParam, param: pb::Param) -> Result<pb::Response, GenErr> {
        Ok(pb::Response::default())
    }
}
#[async_trait]
pub trait RPC_Upload_Handler {
    async fn UploadFile(up: &UserParam, param: pb::UploadFileParam) -> Result<pb::UploadFileResponse, GenErr> {
        Ok(pb::UploadFileResponse::default())
    }
}
#[async_trait]
pub trait RPC_User_Handler {
    async fn UserRegisterUser(up: &UserParam, param: pb::UserRegisterUserParam) -> Result<pb::UserRegisterUserResponse, GenErr> {
        Ok(pb::UserRegisterUserResponse::default())
    }
    async fn UserEditUser(up: &UserParam, param: pb::UserEditUserParam) -> Result<pb::UserEditUserResponse, GenErr> {
        Ok(pb::UserEditUserResponse::default())
    }
    async fn UserDeleteSendCode(up: &UserParam, param: pb::UserDeleteSendCodeParam) -> Result<pb::UserDeleteSendCodeResponse, GenErr> {
        Ok(pb::UserDeleteSendCodeResponse::default())
    }
    async fn UserDeleteConfirmCode(up: &UserParam, param: pb::UserDeleteConfirmCodeParam) -> Result<pb::UserDeleteConfirmCodeResponse, GenErr> {
        Ok(pb::UserDeleteConfirmCodeResponse::default())
    }
    async fn UserDeleteUser(up: &UserParam, param: pb::UserDeleteUserParam) -> Result<pb::UserDeleteUserResponse, GenErr> {
        Ok(pb::UserDeleteUserResponse::default())
    }
    async fn UserChangePhoneNumber(up: &UserParam, param: pb::UserChangePhoneNumberParam) -> Result<pb::UserChangePhoneNumberResponse, GenErr> {
        Ok(pb::UserChangePhoneNumberResponse::default())
    }
    async fn UserRemoveSession(up: &UserParam, param: pb::UserRemoveSessionParam) -> Result<pb::UserRemoveSessionResponse, GenErr> {
        Ok(pb::UserRemoveSessionResponse::default())
    }
    async fn UserRemoveOtherSessions(up: &UserParam, param: pb::UserRemoveOtherParam) -> Result<pb::UserRemoveOtherResponse, GenErr> {
        Ok(pb::UserRemoveOtherResponse::default())
    }
    async fn UserGetMe(up: &UserParam, param: pb::UserGetMeParam) -> Result<pb::UserGetMeResponse, GenErr> {
        Ok(pb::UserGetMeResponse::default())
    }
    async fn UserGetActiveSessions(up: &UserParam, param: pb::UserGetActiveSessionsParam) -> Result<pb::UserGetActiveSessionsResponse, GenErr> {
...
pub trait RPC_Auth_Handler2 : Send + Sync {
    async fn AuthSendCode(&self, param: pb::AuthSendCodeParam) -> Result<pb::AuthSendCodeResponse, GenErr> {
        Ok(pb::AuthSendCodeResponse::default())
    }
    async fn AuthLogIn(&self, param: pb::AuthLogInParam) -> Result<pb::AuthLogInResponse, GenErr> {
        Ok(pb::AuthLogInResponse::default())
    }
    async fn AuthLogOut(&self, param: pb::AuthLogOutParam) -> Result<pb::AuthLogOutResponse, GenErr> {
        Ok(pb::AuthLogOutResponse::default())
    }
}
#[async_trait]
pub trait RPC_Channel_Handler2 : Send + Sync {
    async fn ChannelCreateChannel(&self, param: pb::ChannelCreateChannelParam) -> Result<pb::ChannelCreateChannelResponse, GenErr> {
        Ok(pb::ChannelCreateChannelResponse::default())
    }
    async fn ChannelEditChannel(&self, param: pb::ChannelEditChannelParam) -> Result<pb::ChannelEditChannelResponse, GenErr> {
        Ok(pb::ChannelEditChannelResponse::default())
    }
    async fn ChannelDeleteChannel(&self, param: pb::ChannelDeleteChannelParam) -> Result<pb::ChannelDeleteChannelResponse, GenErr> {
        Ok(pb::ChannelDeleteChannelResponse::default())
    }
    async fn ChannelAddAuthor(&self, param: pb::ChannelAddAuthorParam) -> Result<pb::ChannelAddAuthorResponse, GenErr> {
        Ok(pb::ChannelAddAuthorResponse::default())
    }
    async fn ChannelChangeAuthorPermission(&self, param: pb::ChannelChangeAuthorPermissionParam) -> Result<pb::ChannelChangeAuthorPermissionResponse, GenErr> {
        Ok(pb::ChannelChangeAuthorPermissionResponse::default())
    }
    async fn ChannelRemoveAuthor(&self, param: pb::ChannelRemoveAuthorParam) -> Result<pb::ChannelRemoveAuthorResponse, GenErr> {
        Ok(pb::ChannelRemoveAuthorResponse::default())
    }
    async fn ChannelFollowChannel(&self, param: pb::ChannelFollowChannelParam) -> Result<pb::ChannelFollowChannelResponse, GenErr> {
        Ok(pb::ChannelFollowChannelResponse::default())
    }
    async fn ChannelUnFollowChannel(&self, param: pb::ChannelUnFollowChannelParam) -> Result<pb::ChannelUnFollowChannelResponse, GenErr> {
        Ok(pb::ChannelUnFollowChannelResponse::default())
    }
    async fn ChannelRemoveFollowers(&self, param: pb::ChannelRemoveFollowersParam) -> Result<pb::ChannelRemoveFollowersResponse, GenErr> {
        Ok(pb::ChannelRemoveFollowersResponse::default())
    }
    async fn ChannelSubscribe(&self, param: pb::ChannelSubscribeParam) -> Result<pb::ChannelSubscribeResponse, GenErr> {
        Ok(pb::ChannelSubscribeResponse::default())
    }
    async fn ChannelUnSubscribe(&self, param: pb::ChannelUnSubscribeParam) -> Result<pb::ChannelUnSubscribeResponse, GenErr> {
        Ok(pb::ChannelUnSubscribeResponse::default())
    }
    async fn ChannelRemoveSubscribers(&self, param: pb::ChannelRemoveSubscribersParam) -> Result<pb::ChannelRemoveSubscribersResponse, GenErr> {
        Ok(pb::ChannelRemoveSubscribersResponse::default())
    }
    async fn ChannelChangePrivacy(&self, param: pb::ChannelChangePrivacyParam) -> Result<pb::ChannelChangePrivacyResponse, GenErr> {
        Ok(pb::ChannelChangePrivacyResponse::default())
    }
    async fn ChannelChangeDefaultPermission(&self, param: pb::ChannelChangeDefaultPermissionParam) -> Result<pb::ChannelChangeDefaultPermissionResponse, GenErr> {
        Ok(pb::ChannelChangeDefaultPermissionResponse::default())
    }
    async fn ChannelRevokeLink(&self, param: pb::ChannelRevokeLinkParam) -> Result<pb::ChannelRevokeLinkResponse, GenErr> {
        Ok(pb::ChannelRevokeLinkResponse::default())
    }
    async fn ChannelChangeUsername(&self, param: pb::ChannelChangeUsernameParam) -> Result<pb::ChannelChangeUsernameResponse, GenErr> {
        Ok(pb::ChannelChangeUsernameResponse::default())
    }
    async fn ChannelBlockProfile(&self, param: pb::ChannelBlockProfileParam) -> Result<pb::ChannelBlockProfileResponse, GenErr> {
        Ok(pb::ChannelBlockProfileResponse::default())
    }
    async fn ChannelSendMessage(&self, param: pb::ChannelSendMessageParam) -> Result<pb::ChannelSendMessageResponse, GenErr> {
        Ok(pb::ChannelSendMessageResponse::default())
    }
    async fn ChannelEditMessage(&self, param: pb::ChannelEditMessageParam) -> Result<pb::ChannelEditMessageResponse, GenErr> {
        Ok(pb::ChannelEditMessageResponse::default())
    }
    async fn ChannelDeleteMessages(&self, param: pb::ChannelDeleteMessagesParam) -> Result<pb::ChannelDeleteMessagesResponse, GenErr> {
        Ok(pb::ChannelDeleteMessagesResponse::default())
    }
    async fn ChannelLikeMessage(&self, param: pb::ChannelLikeMessageParam) -> Result<pb::ChannelLikeMessageResponse, GenErr> {
        Ok(pb::ChannelLikeMessageResponse::default())
    }
    async fn ChannelUnLikeMessage(&self, param: pb::ChannelUnLikeMessageParam) -> Result<pb::ChannelUnLikeMessageResponse, GenErr> {
        Ok(pb::ChannelUnLikeMessageResponse::default())
    }
    async fn ChannelReShareMessage(&self, param: pb::ChannelReShareMessageParam) -> Result<pb::ChannelReShareMessageResponse, GenErr> {
        Ok(pb::ChannelReShareMessageResponse::default())
    }
    async fn ChannelUnReShareMessage(&self, param: pb::ChannelUnReShareMessageParam) -> Result<pb::ChannelUnReShareMessageResponse, GenErr> {
        Ok(pb::ChannelUnReShareMessageResponse::default())
    }
    async fn ChannelAddComment(&self, param: pb::ChannelAddCommentParam) -> Result<pb::ChannelAddCommentResponse, GenErr> {
        Ok(pb::ChannelAddCommentResponse::default())
    }
    async fn ChannelDeleteComment(&self, param: pb::ChannelDeleteCommentParam) -> Result<pb::ChannelDeleteCommentResponse, GenErr> {
        Ok(pb::ChannelDeleteCommentResponse::default())
    }
    async fn ChannelPinMessage(&self, param: pb::ChannelPinMessageParam) -> Result<pb::ChannelPinMessageResponse, GenErr> {
        Ok(pb::ChannelPinMessageResponse::default())
    }
    async fn ChannelUnPinMessage(&self, param: pb::ChannelUnPinMessageParam) -> Result<pb::ChannelUnPinMessageResponse, GenErr> {
        Ok(pb::ChannelUnPinMessageResponse::default())
    }
    async fn ChannelAvatarAdd(&self, param: pb::ChannelAvatarAddParam) -> Result<pb::ChannelAvatarAddResponse, GenErr> {
        Ok(pb::ChannelAvatarAddResponse::default())
    }
    async fn ChannelAvatarDelete(&self, param: pb::ChannelAvatarDeleteParam) -> Result<pb::ChannelAvatarDeleteResponse, GenErr> {
        Ok(pb::ChannelAvatarDeleteResponse::default())
    }
    async fn ChannelSendDoingAction(&self, param: pb::ChannelSendDoingActionParam) -> Result<pb::ChannelSendDoingActionResponse, GenErr> {
        Ok(pb::ChannelSendDoingActionResponse::default())
    }
    async fn ChannelReportChannel(&self, param: pb::ChannelReportChannelParam) -> Result<pb::ChannelReportChannelResponse, GenErr> {
        Ok(pb::ChannelReportChannelResponse::default())
    }
    async fn ChannelReportMessage(&self, param: pb::ChannelReportMessageParam) -> Result<pb::ChannelReportMessageResponse, GenErr> {
        Ok(pb::ChannelReportMessageResponse::default())
    }
    async fn ChannelGetFull(&self, param: pb::ChannelGetFullParam) -> Result<pb::ChannelGetFullResponse, GenErr> {
        Ok(pb::ChannelGetFullResponse::default())
    }
    async fn ChannelGetMessagesList(&self, param: pb::ChannelGetMessagesListParam) -> Result<pb::ChannelGetMessagesListResponse, GenErr> {
        Ok(pb::ChannelGetMessagesListResponse::default())
    }
    async fn ChannelGetMediaList(&self, param: pb::ChannelGetMediaListParam) -> Result<pb::ChannelGetMediaListResponse, GenErr> {
        Ok(pb::ChannelGetMediaListResponse::default())
    }
    async fn ChannelGetAuthors(&self, param: pb::ChannelGetAuthorsParam) -> Result<pb::ChannelGetAuthorsResponse, GenErr> {
        Ok(pb::ChannelGetAuthorsResponse::default())
    }
    async fn ChannelGetFollowers(&self, param: pb::ChannelGetFollowersParam) -> Result<pb::ChannelGetFollowersResponse, GenErr> {
        Ok(pb::ChannelGetFollowersResponse::default())
    }
    async fn ChannelGetSubscribers(&self, param: pb::ChannelGetSubscribersParam) -> Result<pb::ChannelGetSubscribersResponse, GenErr> {
        Ok(pb::ChannelGetSubscribersResponse::default())
    }
    async fn ChannelBlocked(&self, param: pb::ChannelBlockedParam) -> Result<pb::ChannelBlockedResponse, GenErr> {
        Ok(pb::ChannelBlockedResponse::default())
    }
    async fn ChannelAvatarGetList(&self, param: pb::ChannelAvatarGetListParam) -> Result<pb::ChannelAvatarGetListResponse, GenErr> {
        Ok(pb::ChannelAvatarGetListResponse::default())
    }
    async fn ChannelGetInbox(&self, param: pb::ChannelGetInboxParam) -> Result<pb::ChannelGetInboxResponse, GenErr> {
        Ok(pb::ChannelGetInboxResponse::default())
    }
    async fn ChannelGetFollowings(&self, param: pb::ChannelGetFollowingsParam) -> Result<pb::ChannelGetFollowingsResponse, GenErr> {
        Ok(pb::ChannelGetFollowingsResponse::default())
    }
}
#[async_trait]
pub trait RPC_Chat_Handler2 : Send + Sync {
    async fn ChatDeleteChat(&self, param: pb::ChatDeleteChatParam) -> Result<pb::ChatDeleteChatResponse, GenErr> {
        Ok(pb::ChatDeleteChatResponse::default())
    }
    async fn ChatSendMessage(&self, param: pb::ChatSendMessageParam) -> Result<pb::ChatSendMessageResponse, GenErr> {
        Ok(pb::ChatSendMessageResponse::default())
    }
    async fn ChatEditMessage(&self, param: pb::ChatEditMessageParam) -> Result<pb::ChatEditMessageResponse, GenErr> {
        Ok(pb::ChatEditMessageResponse::default())
    }
    async fn ChatDeleteMessages(&self, param: pb::ChatDeleteMessagesParam) -> Result<pb::ChatDeleteMessagesResponse, GenErr> {
        Ok(pb::ChatDeleteMessagesResponse::default())
    }
    async fn ChatDeleteHistory(&self, param: pb::ChatDeleteHistoryParam) -> Result<pb::ChatDeleteHistoryResponse, GenErr> {
        Ok(pb::ChatDeleteHistoryResponse::default())
    }
    async fn ChatSetNotification(&self, param: pb::ChatSetNotificationParam) -> Result<pb::ChatSetNotificationResponse, GenErr> {
        Ok(pb::ChatSetNotificationResponse::default())
    }
    async fn ChatSendDoingAction(&self, param: pb::ChatSendDoingActionParam) -> Result<pb::ChatSendDoingActionResponse, GenErr> {
        Ok(pb::ChatSendDoingActionResponse::default())
    }
    async fn ChatReportChat(&self, param: pb::ChatReportChatParam) -> Result<pb::ChatReportChatResponse, GenErr> {
        Ok(pb::ChatReportChatResponse::default())
    }
    async fn ChatGetFull(&self, param: pb::ChatGetFullMessageParam) -> Result<pb::ChatGetFullMessageResponse, GenErr> {
        Ok(pb::ChatGetFullMessageResponse::default())
    }
    async fn ChatGetMessagesList(&self, param: pb::ChatGetMessagesListParam) -> Result<pb::ChatGetMessagesListResponse, GenErr> {
        Ok(pb::ChatGetMessagesListResponse::default())
    }
    async fn ChatGetMediaList(&self, param: pb::ChatGetMediaListParam) -> Result<pb::ChatGetMediaListResponse, GenErr> {
        Ok(pb::ChatGetMediaListResponse::default())
    }
    async fn ChatGetInbox(&self, param: pb::ChatGetInboxParam) -> Result<pb::ChatGetInboxResponse, GenErr> {
        Ok(pb::ChatGetInboxResponse::default())
    }
}
#[async_trait]
pub trait RPC_Group_Handler2 : Send + Sync {
    async fn GroupCreateGroup(&self, param: pb::GroupCreateGroupParam) -> Result<pb::GroupCreateGroupResponse, GenErr> {
        Ok(pb::GroupCreateGroupResponse::default())
    }
    async fn GroupEditGroup(&self, param: pb::GroupEditGroupParam) -> Result<pb::GroupEditGroupResponse, GenErr> {
        Ok(pb::GroupEditGroupResponse::default())
    }
    async fn GroupDeleteGroup(&self, param: pb::GroupDeleteGroupParam) -> Result<pb::GroupDeleteGroupResponse, GenErr> {
        Ok(pb::GroupDeleteGroupResponse::default())
    }
    async fn GroupAddAdmin(&self, param: pb::GroupAddAdminParam) -> Result<pb::GroupAddAdminResponse, GenErr> {
        Ok(pb::GroupAddAdminResponse::default())
    }
    async fn GroupRemoveMember(&self, param: pb::GroupRemoveMemberParam) -> Result<pb::GroupRemoveMemberResponse, GenErr> {
        Ok(pb::GroupRemoveMemberResponse::default())
    }
    async fn GroupChangeMemberLevel(&self, param: pb::GroupChangeMemberLevelParam) -> Result<pb::GroupChangeMemberLevelResponse, GenErr> {
        Ok(pb::GroupChangeMemberLevelResponse::default())
    }
    async fn GroupChangeMemberPermission(&self, param: pb::GroupChangeMemberPermissionParam) -> Result<pb::GroupChangeMemberPermissionResponse, GenErr> {
        Ok(pb::GroupChangeMemberPermissionResponse::default())
    }
    async fn GroupBanMember(&self, param: pb::GroupBanMemberParam) -> Result<pb::GroupBanMemberResponse, GenErr> {
        Ok(pb::GroupBanMemberResponse::default())
    }
    async fn GroupJoinGroup(&self, param: pb::JoinGroupParam) -> Result<pb::JoinGroupResponse, GenErr> {
        Ok(pb::JoinGroupResponse::default())
    }
    async fn GroupLeaveGroup(&self, param: pb::GroupLeaveGroupParam) -> Result<pb::GroupLeaveGroupResponse, GenErr> {
        Ok(pb::GroupLeaveGroupResponse::default())
    }
    async fn GroupAddMember(&self, param: pb::GroupAddMemberParam) -> Result<pb::GroupAddMemberResponse, GenErr> {
        Ok(pb::GroupAddMemberResponse::default())
    }
    async fn GroupSetNotification(&self, param: pb::GroupSetNotificationParam) -> Result<pb::GroupSetNotificationResponse, GenErr> {
        Ok(pb::GroupSetNotificationResponse::default())
    }
    async fn GroupChangePrivacy(&self, param: pb::GroupChangePrivacyParam) -> Result<pb::GroupChangePrivacyResponse, GenErr> {
        Ok(pb::GroupChangePrivacyResponse::default())
    }
    async fn GroupChangeDefaultPermission(&self, param: pb::GroupChangeDefaultPermissionParam) -> Result<pb::GroupChangeDefaultPermissionResponse, GenErr> {
        Ok(pb::GroupChangeDefaultPermissionResponse::default())
    }
    async fn GroupRevokeLink(&self, param: pb::GroupRevokeLinkParam) -> Result<pb::GroupRevokeLinkResponse, GenErr> {
        Ok(pb::GroupRevokeLinkResponse::default())
    }
    async fn GroupChangeUsername(&self, param: pb::GroupChangeUsernameParam) -> Result<pb::GroupChangeUsernameResponse, GenErr> {
        Ok(pb::GroupChangeUsernameResponse::default())
    }
    async fn GroupSendMessage(&self, param: pb::GroupSendMessageParam) -> Result<pb::GroupSendMessageResponse, GenErr> {
        Ok(pb::GroupSendMessageResponse::default())
    }
    async fn GroupEditMessage(&self, param: pb::GroupEditMessageParam) -> Result<pb::GroupEditMessageResponse, GenErr> {
        Ok(pb::GroupEditMessageResponse::default())
    }
    async fn GroupDeleteMessages(&self, param: pb::GroupDeleteMessagesParam) -> Result<pb::GroupDeleteMessagesResponse, GenErr> {
        Ok(pb::GroupDeleteMessagesResponse::default())
    }
    async fn GroupDeleteHistory(&self, param: pb::GroupDeleteHistoryParam) -> Result<pb::GroupDeleteHistoryResponse, GenErr> {
        Ok(pb::GroupDeleteHistoryResponse::default())
    }
    async fn GroupPinMessage(&self, param: pb::GroupPinMessageParam) -> Result<pb::GroupPinMessageResponse, GenErr> {
        Ok(pb::GroupPinMessageResponse::default())
    }
    async fn GroupUnPinMessage(&self, param: pb::GroupUnPinMessageParam) -> Result<pb::GroupUnPinMessageResponse, GenErr> {
        Ok(pb::GroupUnPinMessageResponse::default())
    }
    async fn GroupAvatarAdd(&self, param: pb::GroupAvatarAddParam) -> Result<pb::GroupAvatarAddResponse, GenErr> {
        Ok(pb::GroupAvatarAddResponse::default())
    }
    async fn GroupAvatarDelete(&self, param: pb::GroupAvatarDeleteParam) -> Result<pb::GroupAvatarDeleteResponse, GenErr> {
        Ok(pb::GroupAvatarDeleteResponse::default())
    }
    async fn GroupSendDoingAction(&self, param: pb::GroupSendDoingActionParam) -> Result<pb::GroupSendDoingActionResponse, GenErr> {
        Ok(pb::GroupSendDoingActionResponse::default())
    }
    async fn GroupReportGroup(&self, param: pb::GroupReportGroupParam) -> Result<pb::GroupReportGroupResponse, GenErr> {
        Ok(pb::GroupReportGroupResponse::default())
    }
    async fn GroupGetFull(&self, param: pb::GroupGetFullParam) -> Result<pb::GroupGetFullResponse, GenErr> {
        Ok(pb::GroupGetFullResponse::default())
    }
    async fn GroupGetMessagesList(&self, param: pb::GroupGetMessagesListParam) -> Result<pb::GroupGetMessagesListResponse, GenErr> {
        Ok(pb::GroupGetMessagesListResponse::default())
    }
    async fn GroupGetMediaList(&self, param: pb::GroupGetMediaListParam) -> Result<pb::GroupGetMediaListResponse, GenErr> {
        Ok(pb::GroupGetMediaListResponse::default())
    }
    async fn GroupGetMembersList(&self, param: pb::GroupGetMembersListParam) -> Result<pb::GroupGetMembersListResponse, GenErr> {
        Ok(pb::GroupGetMembersListResponse::default())
    }
    async fn GroupGetAdminsList(&self, param: pb::GroupGetAdminsListParam) -> Result<pb::GroupGetAdminsListResponse, GenErr> {
        Ok(pb::GroupGetAdminsListResponse::default())
    }
    async fn GroupAvatarGetList(&self, param: pb::GroupAvatarGetListParam) -> Result<pb::GroupAvatarGetListResponse, GenErr> {
        Ok(pb::GroupAvatarGetListResponse::default())
    }
    async fn GroupGetInbox(&self, param: pb::GroupGetInboxParam) -> Result<pb::GroupGetInboxResponse, GenErr> {
        Ok(pb::GroupGetInboxResponse::default())
    }
}
#[async_trait]
pub trait RPC_Profile_Handler2 : Send + Sync {
    async fn ProfileSetSettings(&self, param: pb::ProfileSetSettingsParam) -> Result<pb::ProfileSetSettingsResponse, GenErr> {
        Ok(pb::ProfileSetSettingsResponse::default())
    }
}
#[async_trait]
pub trait RPC_Sample_Handler2 : Send + Sync {
    ...
    async fn GetProfiles(&self, param: pb::GetProfilesParam) -> Result<pb::GetProfilesResponse, GenErr> {
        Ok(pb::GetProfilesResponse::default())
    }
    async fn GetChannels(&self, param: pb::GetChannelsParam) -> Result<pb::GetChannelsResponse, GenErr> {
        Ok(pb::GetChannelsResponse::default())
    }
    async fn GetDirects(&self, param: pb::GetDirectsParam) -> Result<pb::GetDirectsResponse, GenErr> {
        Ok(pb::GetDirectsResponse::default())
    }
    async fn GetMessages(&self, param: pb::GetMessagesParam) -> Result<pb::GetMessagesResponse, GenErr> {
        Ok(pb::GetMessagesResponse::default())
    }
}
#[async_trait]
pub trait RPC_Shared_Handler2 : Send + Sync {
    async fn SharedEcho(&self, param: pb::SharedEchoParam) -> Result<pb::SharedEchoResponse, GenErr> {
        Ok(pb::SharedEchoResponse::default())
    }
    async fn SharedCheckUserName(&self, param: pb::SharedCheckUserNameParam) -> Result<pb::SharedCheckUserNameResponse, GenErr> {
        Ok(pb::SharedCheckUserNameResponse::default())
    }
}
#[async_trait]
...
pub trait RPC_Upload_Handler2 : Send + Sync {
    async fn UploadFile(&self, param: pb::UploadFileParam) -> Result<pb::UploadFileResponse, GenErr> {
        Ok(pb::UploadFileResponse::default())
    }
}
#[async_trait]
pub trait RPC_User_Handler2 : Send + Sync {
    async fn UserRegisterUser(&self, param: pb::UserRegisterUserParam) -> Result<pb::UserRegisterUserResponse, GenErr> {
        Ok(pb::UserRegisterUserResponse::default())
    }
    async fn UserEditUser(&self, param: pb::UserEditUserParam) -> Result<pb::UserEditUserResponse, GenErr> {
        Ok(pb::UserEditUserResponse::default())
    }
    async fn UserDeleteSendCode(&self, param: pb::UserDeleteSendCodeParam) -> Result<pb::UserDeleteSendCodeResponse, GenErr> {
        Ok(pb::UserDeleteSendCodeResponse::default())
    }
    async fn UserDeleteConfirmCode(&self, param: pb::UserDeleteConfirmCodeParam) -> Result<pb::UserDeleteConfirmCodeResponse, GenErr> {
        Ok(pb::UserDeleteConfirmCodeResponse::default())
    }
    async fn UserDeleteUser(&self, param: pb::UserDeleteUserParam) -> Result<pb::UserDeleteUserResponse, GenErr> {
        Ok(pb::UserDeleteUserResponse::default())
    }
    async fn UserChangePhoneNumber(&self, param: pb::UserChangePhoneNumberParam) -> Result<pb::UserChangePhoneNumberResponse, GenErr> {
        Ok(pb::UserChangePhoneNumberResponse::default())
    }
    async fn UserRemoveSession(&self, param: pb::UserRemoveSessionParam) -> Result<pb::UserRemoveSessionResponse, GenErr> {
        Ok(pb::UserRemoveSessionResponse::default())
    }
    async fn UserRemoveOtherSessions(&self, param: pb::UserRemoveOtherParam) -> Result<pb::UserRemoveOtherResponse, GenErr> {
        Ok(pb::UserRemoveOtherResponse::default())
    }
    async fn UserGetMe(&self, param: pb::UserGetMeParam) -> Result<pb::UserGetMeResponse, GenErr> {
        Ok(pb::UserGetMeResponse::default())
    }
    async fn UserGetActiveSessions(&self, param: pb::UserGetActiveSessionsParam) -> Result<pb::UserGetActiveSessionsResponse, GenErr> {
        Ok(pb::UserGetActiveSessionsResponse::default())
    }
}

#[async_trait]
pub trait All_Rpc_Handler :IPC_CMaster_Handler2 +RPC_Auth_Handler2 +RPC_Channel_Handler2 +RPC_Chat_Handler2 +RPC_Group_Handler2 +RPC_Profile_Handler2 +RPC_Sample_Handler2 +RPC_Shared_Handler2 +RPC_Shop_Handler2 +RPC_Upload_Handler2 +RPC_User_Handler2 +Clone + Send + Sync {}
...
pub fn invoke_to_parsed(invoke: &pb::Invoke) -> Result<RpcInvoke, GenErr>{
    ...
    // RPC_Auth
        method_ids::AuthSendCode => {
           let rpc_param: pb::AuthSendCodeParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::AuthLogOut => {
           let rpc_param: pb::AuthLogOutParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Channel
        method_ids::ChannelCreateChannel => {
           let rpc_param: pb::ChannelCreateChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelEditChannel => {
           let rpc_param: pb::ChannelEditChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelDeleteChannel => {
           let rpc_param: pb::ChannelDeleteChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelAddAuthor => {
           let rpc_param: pb::ChannelAddAuthorParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelChangeAuthorPermission => {
           let rpc_param: pb::ChannelChangeAuthorPermissionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 93233821 as i64,
                rpc_service: RPC_Channel(RPC_Channel_MethodData::ChannelChangeAuthorPermission(rpc_param)),
           }
        },

        method_ids::ChannelRemoveAuthor => {
           let rpc_param: pb::ChannelRemoveAuthorParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelFollowChannel => {
           let rpc_param: pb::ChannelFollowChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelUnFollowChannel => {
           let rpc_param: pb::ChannelUnFollowChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelRemoveFollowers => {
           let rpc_param: pb::ChannelRemoveFollowersParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelSubscribe => {
           let rpc_param: pb::ChannelSubscribeParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelUnSubscribe => {
           let rpc_param: pb::ChannelUnSubscribeParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelRemoveSubscribers => {
           let rpc_param: pb::ChannelRemoveSubscribersParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 729024592 as i64,
                rpc_service: RPC_Channel(RPC_Channel_MethodData::ChannelRemoveSubscribers(rpc_param)),
           }
        },

        method_ids::ChannelChangePrivacy => {
           let rpc_param: pb::ChannelChangePrivacyParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelChangeDefaultPermission => {
           let rpc_param: pb::ChannelChangeDefaultPermissionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 1582638498 as i64,
                rpc_service: RPC_Channel(RPC_Channel_MethodData::ChannelChangeDefaultPermission(rpc_param)),
           }
        },

        method_ids::ChannelRevokeLink => {
           let rpc_param: pb::ChannelRevokeLinkParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelChangeUsername => {
           let rpc_param: pb::ChannelChangeUsernameParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelBlockProfile => {
           let rpc_param: pb::ChannelBlockProfileParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelSendMessage => {
           let rpc_param: pb::ChannelSendMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelEditMessage => {
           let rpc_param: pb::ChannelEditMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelDeleteMessages => {
           let rpc_param: pb::ChannelDeleteMessagesParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelLikeMessage => {
           let rpc_param: pb::ChannelLikeMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelUnLikeMessage => {
           let rpc_param: pb::ChannelUnLikeMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelReShareMessage => {
           let rpc_param: pb::ChannelReShareMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelUnReShareMessage => {
           let rpc_param: pb::ChannelUnReShareMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 1173971596 as i64,
                rpc_service: RPC_Channel(RPC_Channel_MethodData::ChannelUnReShareMessage(rpc_param)),
           }
        },

        method_ids::ChannelAddComment => {
           let rpc_param: pb::ChannelAddCommentParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelDeleteComment => {
           let rpc_param: pb::ChannelDeleteCommentParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelPinMessage => {
           let rpc_param: pb::ChannelPinMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelUnPinMessage => {
           let rpc_param: pb::ChannelUnPinMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelAvatarAdd => {
           let rpc_param: pb::ChannelAvatarAddParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelAvatarDelete => {
           let rpc_param: pb::ChannelAvatarDeleteParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelSendDoingAction => {
           let rpc_param: pb::ChannelSendDoingActionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelReportChannel => {
           let rpc_param: pb::ChannelReportChannelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelReportMessage => {
           let rpc_param: pb::ChannelReportMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetFull => {
           let rpc_param: pb::ChannelGetFullParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetMessagesList => {
           let rpc_param: pb::ChannelGetMessagesListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetMediaList => {
           let rpc_param: pb::ChannelGetMediaListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetAuthors => {
           let rpc_param: pb::ChannelGetAuthorsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetFollowers => {
           let rpc_param: pb::ChannelGetFollowersParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetSubscribers => {
           let rpc_param: pb::ChannelGetSubscribersParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelBlocked => {
           let rpc_param: pb::ChannelBlockedParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelAvatarGetList => {
           let rpc_param: pb::ChannelAvatarGetListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetInbox => {
           let rpc_param: pb::ChannelGetInboxParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChannelGetFollowings => {
           let rpc_param: pb::ChannelGetFollowingsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Chat
        method_ids::ChatDeleteChat => {
           let rpc_param: pb::ChatDeleteChatParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatSendMessage => {
           let rpc_param: pb::ChatSendMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatEditMessage => {
           let rpc_param: pb::ChatEditMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatDeleteMessages => {
           let rpc_param: pb::ChatDeleteMessagesParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatDeleteHistory => {
           let rpc_param: pb::ChatDeleteHistoryParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatSetNotification => {
           let rpc_param: pb::ChatSetNotificationParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatSendDoingAction => {
           let rpc_param: pb::ChatSendDoingActionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatReportChat => {
           let rpc_param: pb::ChatReportChatParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatGetFull => {
           let rpc_param: pb::ChatGetFullMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatGetMessagesList => {
           let rpc_param: pb::ChatGetMessagesListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatGetMediaList => {
           let rpc_param: pb::ChatGetMediaListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::ChatGetInbox => {
           let rpc_param: pb::ChatGetInboxParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Group
        method_ids::GroupCreateGroup => {
           let rpc_param: pb::GroupCreateGroupParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupEditGroup => {
           let rpc_param: pb::GroupEditGroupParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupDeleteGroup => {
           let rpc_param: pb::GroupDeleteGroupParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupAddAdmin => {
           let rpc_param: pb::GroupAddAdminParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupRemoveMember => {
           let rpc_param: pb::GroupRemoveMemberParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupChangeMemberLevel => {
           let rpc_param: pb::GroupChangeMemberLevelParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupChangeMemberPermission => {
           let rpc_param: pb::GroupChangeMemberPermissionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 2132464067 as i64,
                rpc_service: RPC_Group(RPC_Group_MethodData::GroupChangeMemberPermission(rpc_param)),
           }
        },

        method_ids::GroupBanMember => {
           let rpc_param: pb::GroupBanMemberParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupLeaveGroup => {
           let rpc_param: pb::GroupLeaveGroupParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupAddMember => {
           let rpc_param: pb::GroupAddMemberParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupSetNotification => {
           let rpc_param: pb::GroupSetNotificationParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupChangePrivacy => {
           let rpc_param: pb::GroupChangePrivacyParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupChangeDefaultPermission => {
           let rpc_param: pb::GroupChangeDefaultPermissionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
                method_id: 605792138 as i64,
                rpc_service: RPC_Group(RPC_Group_MethodData::GroupChangeDefaultPermission(rpc_param)),
           }
        },

        method_ids::GroupRevokeLink => {
           let rpc_param: pb::GroupRevokeLinkParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupChangeUsername => {
           let rpc_param: pb::GroupChangeUsernameParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupSendMessage => {
           let rpc_param: pb::GroupSendMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupEditMessage => {
           let rpc_param: pb::GroupEditMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupDeleteMessages => {
           let rpc_param: pb::GroupDeleteMessagesParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupDeleteHistory => {
           let rpc_param: pb::GroupDeleteHistoryParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupPinMessage => {
           let rpc_param: pb::GroupPinMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupUnPinMessage => {
           let rpc_param: pb::GroupUnPinMessageParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupAvatarAdd => {
           let rpc_param: pb::GroupAvatarAddParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupAvatarDelete => {
           let rpc_param: pb::GroupAvatarDeleteParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupSendDoingAction => {
           let rpc_param: pb::GroupSendDoingActionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupReportGroup => {
           let rpc_param: pb::GroupReportGroupParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetFull => {
           let rpc_param: pb::GroupGetFullParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetMessagesList => {
           let rpc_param: pb::GroupGetMessagesListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetMediaList => {
           let rpc_param: pb::GroupGetMediaListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetMembersList => {
           let rpc_param: pb::GroupGetMembersListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetAdminsList => {
           let rpc_param: pb::GroupGetAdminsListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupAvatarGetList => {
           let rpc_param: pb::GroupAvatarGetListParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GroupGetInbox => {
           let rpc_param: pb::GroupGetInboxParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Profile
        method_ids::ProfileSetSettings => {
           let rpc_param: pb::ProfileSetSettingsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Sample
        ...
        method_ids::GetProfiles => {
           let rpc_param: pb::GetProfilesParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GetChannels => {
           let rpc_param: pb::GetChannelsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GetDirects => {
           let rpc_param: pb::GetDirectsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::GetMessages => {
           let rpc_param: pb::GetMessagesParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Shared
        method_ids::SharedEcho => {
           let rpc_param: pb::SharedEchoParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::SharedCheckUserName => {
           let rpc_param: pb::SharedCheckUserNameParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_Upload
        method_ids::UploadFile => {
           let rpc_param: pb::UploadFileParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
    ...
    // RPC_User
        method_ids::UserRegisterUser => {
           let rpc_param: pb::UserRegisterUserParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserEditUser => {
           let rpc_param: pb::UserEditUserParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserDeleteSendCode => {
           let rpc_param: pb::UserDeleteSendCodeParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserDeleteConfirmCode => {
           let rpc_param: pb::UserDeleteConfirmCodeParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserDeleteUser => {
           let rpc_param: pb::UserDeleteUserParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserChangePhoneNumber => {
           let rpc_param: pb::UserChangePhoneNumberParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserRemoveSession => {
           let rpc_param: pb::UserRemoveSessionParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserRemoveOtherSessions => {
           let rpc_param: pb::UserRemoveOtherParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
        ...
        method_ids::UserGetActiveSessions => {
           let rpc_param: pb::UserGetActiveSessionsParam = prost::Message::decode(invoke.rpc_data.as_slice())?;
           RpcInvoke{
...
// service: IPC_CMaster
    pub async fn GetNextId (&self, param: pb::GetNextIdParam)
...
// service: RPC_Channel
    ...
    pub async fn ChannelUnFollowChannel (&self, param: pb::ChannelUnFollowChannelParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelUnFollowChannel).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelRemoveSubscribers (&self, param: pb::ChannelRemoveSubscribersParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelRemoveSubscribers).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelChangePrivacy (&self, param: pb::ChannelChangePrivacyParam)
        -> Result<pb::ChannelChangePrivacyResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelChangePrivacy).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelChangeDefaultPermission (&self, param: pb::ChannelChangeDefaultPermissionParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelChangeDefaultPermission).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelRevokeLink (&self, param: pb::ChannelRevokeLinkParam)
        -> Result<pb::ChannelRevokeLinkResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelRevokeLink).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelChangeUsername (&self, param: pb::ChannelChangeUsernameParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelChangeUsername).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelBlockProfile (&self, param: pb::ChannelBlockProfileParam)
        -> Result<pb::ChannelBlockProfileResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelBlockProfile).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelSendMessage (&self, param: pb::ChannelSendMessageParam)
        -> Result<pb::ChannelSendMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelSendMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelEditMessage (&self, param: pb::ChannelEditMessageParam)
        -> Result<pb::ChannelEditMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelEditMessage).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelDeleteMessages (&self, param: pb::ChannelDeleteMessagesParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelDeleteMessages).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelLikeMessage (&self, param: pb::ChannelLikeMessageParam)
        -> Result<pb::ChannelLikeMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelLikeMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelUnLikeMessage (&self, param: pb::ChannelUnLikeMessageParam)
        -> Result<pb::ChannelUnLikeMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelUnLikeMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelReShareMessage (&self, param: pb::ChannelReShareMessageParam)
        -> Result<pb::ChannelReShareMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelReShareMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelUnReShareMessage (&self, param: pb::ChannelUnReShareMessageParam)
        -> Result<pb::ChannelUnReShareMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelUnReShareMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelAddComment (&self, param: pb::ChannelAddCommentParam)
        -> Result<pb::ChannelAddCommentResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelAddComment).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelDeleteComment (&self, param: pb::ChannelDeleteCommentParam)
        -> Result<pb::ChannelDeleteCommentResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelDeleteComment).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelPinMessage (&self, param: pb::ChannelPinMessageParam)
        -> Result<pb::ChannelPinMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelPinMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelUnPinMessage (&self, param: pb::ChannelUnPinMessageParam)
        -> Result<pb::ChannelUnPinMessageResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelUnPinMessage).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelAvatarAdd (&self, param: pb::ChannelAvatarAddParam)
        -> Result<pb::ChannelAvatarAddResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelAvatarAdd).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelAvatarDelete (&self, param: pb::ChannelAvatarDeleteParam)
        -> Result<pb::ChannelAvatarDeleteResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelAvatarDelete).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelGetSubscribers (&self, param: pb::ChannelGetSubscribersParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelGetSubscribers).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChannelAvatarGetList (&self, param: pb::ChannelAvatarGetListParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelAvatarGetList).await?;
        Ok(pb_res)
    }
    
    pub async fn ChannelGetInbox (&self, param: pb::ChannelGetInboxParam)
    ...
    pub async fn ChannelGetFollowings (&self, param: pb::ChannelGetFollowingsParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChannelGetFollowings).await?;
        Ok(pb_res)
    }
    
// service: RPC_Chat
    pub async fn ChatDeleteChat (&self, param: pb::ChatDeleteChatParam)
    ...
    pub async fn ChatDeleteMessages (&self, param: pb::ChatDeleteMessagesParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChatDeleteMessages).await?;
        Ok(pb_res)
    }
    
    pub async fn ChatDeleteHistory (&self, param: pb::ChatDeleteHistoryParam)
        -> Result<pb::ChatDeleteHistoryResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChatDeleteHistory).await?;
        Ok(pb_res)
    }
    
    pub async fn ChatSetNotification (&self, param: pb::ChatSetNotificationParam)
        -> Result<pb::ChatSetNotificationResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChatSetNotification).await?;
        Ok(pb_res)
    }
    
    pub async fn ChatSendDoingAction (&self, param: pb::ChatSendDoingActionParam)
        -> Result<pb::ChatSendDoingActionResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChatSendDoingAction).await?;
        Ok(pb_res)
    }
    ...
    pub async fn ChatGetMessagesList (&self, param: pb::ChatGetMessagesListParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::ChatGetMessagesList).await?;
        Ok(pb_res)
    }
    
    pub async fn ChatGetMediaList (&self, param: pb::ChatGetMediaListParam)
        -> Result<pb::ChatGetMediaListResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ChatGetMediaList).await?;
        Ok(pb_res)
    }
    
    pub async fn ChatGetInbox (&self, param: pb::ChatGetInboxParam)
...
// service: RPC_Group
    pub async fn GroupCreateGroup (&self, param: pb::GroupCreateGroupParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupCreateGroup).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupDeleteGroup (&self, param: pb::GroupDeleteGroupParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupDeleteGroup).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupRemoveMember (&self, param: pb::GroupRemoveMemberParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupRemoveMember).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupChangeMemberLevel (&self, param: pb::GroupChangeMemberLevelParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupChangeMemberLevel).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupChangeMemberPermission (&self, param: pb::GroupChangeMemberPermissionParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupChangeMemberPermission).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupSetNotification (&self, param: pb::GroupSetNotificationParam)
        -> Result<pb::GroupSetNotificationResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::GroupSetNotification).await?;
        Ok(pb_res)
    }
    
    pub async fn GroupChangePrivacy (&self, param: pb::GroupChangePrivacyParam)
        -> Result<pb::GroupChangePrivacyResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::GroupChangePrivacy).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupChangeDefaultPermission (&self, param: pb::GroupChangeDefaultPermissionParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupChangeDefaultPermission).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupUnPinMessage (&self, param: pb::GroupUnPinMessageParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupUnPinMessage).await?;
        Ok(pb_res)
    }
    ...
    pub async fn GroupAvatarDelete (&self, param: pb::GroupAvatarDeleteParam)
        ...
        let pb_res = self.rpc_invoke(&param, method_ids::GroupAvatarDelete).await?;
        Ok(pb_res)
    }
    
    pub async fn GroupSendDoingAction (&self, param: pb::GroupSendDoingActionParam)
        -> Result<pb::GroupSendDoingActionResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::GroupSendDoingAction).await?;
        Ok(pb_res)
    }
    
    pub async fn GroupReportGroup (&self, param: pb::GroupReportGroupParam)
        -> Result<pb::GroupReportGroupResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::GroupReportGroup).await?;
        Ok(pb_res)
    }
    
    pub async fn GroupGetFull (&self, param: pb::GroupGetFullParam)
...
// service: RPC_Profile
    pub async fn ProfileSetSettings (&self, param: pb::ProfileSetSettingsParam)
        -> Result<pb::ProfileSetSettingsResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ProfileSetSettings).await?;
        Ok(pb_res)
    }
...
// service: RPC_Shared
    pub async fn SharedEcho (&self, param: pb::SharedEchoParam)
        -> Result<pb::SharedEchoResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::SharedEcho).await?;
        Ok(pb_res)
    }
    
    pub async fn SharedCheckUserName (&self, param: pb::SharedCheckUserNameParam)
        -> Result<pb::SharedCheckUserNameResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::SharedCheckUserName).await?;
        Ok(pb_res)
    }
    
// service: RPC_Shop
    pub async fn ShopEEE (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEEE).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopCreateShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopCreateShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopEditShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEditShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopPauseShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopPauseShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopTerminateShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopTerminateShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopAddProduct (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopAddProduct).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopEditProduct (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEditProduct).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopDeleteProduct (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopDeleteProduct).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopAddProductToBasket (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopAddProductToBasket).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopRemoveProductFromBasket (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopRemoveProductFromBasket).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopCheckoutBasket (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopCheckoutBasket).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopLikeProduct (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopLikeProduct).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopUnLikeProduct (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopUnLikeProduct).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopLikeShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopLikeShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopUnLikeShop (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopUnLikeShop).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetFull (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetFull).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopProductList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopProductList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetBasketList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetBasketList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetLikedProductsList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetLikedProductsList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetLikedShopsList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetLikedShopsList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetOrderList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetOrderList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopGetRefundList (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopGetRefundList).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopCancelOrder (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopCancelOrder).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopEditProductInfo (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEditProductInfo).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopEditProductPrice (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEditProductPrice).await?;
        Ok(pb_res)
    }
    
    pub async fn ShopEditProductInventory (&self, param: pb::Param)
        -> Result<pb::Response,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::ShopEditProductInventory).await?;
        Ok(pb_res)
    }
...
// service: RPC_User
    pub async fn UserRegisterUser (&self, param: pb::UserRegisterUserParam)
        -> Result<pb::UserRegisterUserResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserRegisterUser).await?;
        Ok(pb_res)
    }
    
    pub async fn UserEditUser (&self, param: pb::UserEditUserParam)
        -> Result<pb::UserEditUserResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserEditUser).await?;
        Ok(pb_res)
    }
    
    pub async fn UserDeleteSendCode (&self, param: pb::UserDeleteSendCodeParam)
        -> Result<pb::UserDeleteSendCodeResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserDeleteSendCode).await?;
        Ok(pb_res)
    }
    
    pub async fn UserDeleteConfirmCode (&self, param: pb::UserDeleteConfirmCodeParam)
        -> Result<pb::UserDeleteConfirmCodeResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserDeleteConfirmCode).await?;
        Ok(pb_res)
    }
    
    pub async fn UserDeleteUser (&self, param: pb::UserDeleteUserParam)
        -> Result<pb::UserDeleteUserResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserDeleteUser).await?;
        Ok(pb_res)
    }
    
    pub async fn UserChangePhoneNumber (&self, param: pb::UserChangePhoneNumberParam)
        -> Result<pb::UserChangePhoneNumberResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserChangePhoneNumber).await?;
        Ok(pb_res)
    }
    
    pub async fn UserRemoveSession (&self, param: pb::UserRemoveSessionParam)
        -> Result<pb::UserRemoveSessionResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserRemoveSession).await?;
        Ok(pb_res)
    }
    
    pub async fn UserRemoveOtherSessions (&self, param: pb::UserRemoveOtherParam)
        -> Result<pb::UserRemoveOtherResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserRemoveOtherSessions).await?;
        Ok(pb_res)
    }
    
    pub async fn UserGetMe (&self, param: pb::UserGetMeParam)
        -> Result<pb::UserGetMeResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserGetMe).await?;
        Ok(pb_res)
    }
    
    pub async fn UserGetActiveSessions (&self, param: pb::UserGetActiveSessionsParam)
        -> Result<pb::UserGetActiveSessionsResponse,GenErr>{
        let pb_res = self.rpc_invoke(&param, method_ids::UserGetActiveSessions).await?;
        Ok(pb_res)
    }
...
/*        
    ...
    pub async fn send_code(&self, p: param::SendCode) -> Result<pb::Auth,GenErr> {
        let _ = pb::AuthSendCodeParam::default();
        unimplemented!("");
    }

    pub async fn log_in(&self, p: param::LogIn) -> Result<pb::Auth,GenErr> {
        let _ = pb::AuthLogInParam::default();
        unimplemented!("");
    }

    pub async fn log_out(&self, p: param::LogOut) -> Result<pb::Auth,GenErr> {
...
/*        
    ...
    pub async fn edit_channel(&self, p: param::EditChannel) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelEditChannelParam::default();
        unimplemented!("");
    }

    pub async fn delete_channel(&self, p: param::DeleteChannel) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelDeleteChannelParam::default();
        unimplemented!("");
    }

    pub async fn add_author(&self, p: param::AddAuthor) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelAddAuthorParam::default();
        unimplemented!("");
    }

    pub async fn change_author_permission(&self, p: param::ChangeAuthorPermission) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelChangeAuthorPermissionParam::default();
        unimplemented!("");
    }

    pub async fn remove_author(&self, p: param::RemoveAuthor) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelRemoveAuthorParam::default();
        unimplemented!("");
    }

    pub async fn follow_channel(&self, p: param::FollowChannel) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelFollowChannelParam::default();
        unimplemented!("");
    }

    pub async fn un_follow_channel(&self, p: param::UnFollowChannel) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelUnFollowChannelParam::default();
        unimplemented!("");
    }

    pub async fn remove_followers(&self, p: param::RemoveFollowers) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelRemoveFollowersParam::default();
        unimplemented!("");
    }

    pub async fn subscribe(&self, p: param::Subscribe) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelSubscribeParam::default();
        unimplemented!("");
    }

    pub async fn un_subscribe(&self, p: param::UnSubscribe) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelUnSubscribeParam::default();
        unimplemented!("");
    }

    pub async fn remove_subscribers(&self, p: param::RemoveSubscribers) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelRemoveSubscribersParam::default();
        unimplemented!("");
    }

    pub async fn change_privacy(&self, p: param::ChangePrivacy) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelChangePrivacyParam::default();
        unimplemented!("");
    }

    pub async fn change_default_permission(&self, p: param::ChangeDefaultPermission) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelChangeDefaultPermissionParam::default();
        unimplemented!("");
    }

    pub async fn revoke_link(&self, p: param::RevokeLink) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelRevokeLinkParam::default();
        unimplemented!("");
    }

    pub async fn change_username(&self, p: param::ChangeUsername) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelChangeUsernameParam::default();
        unimplemented!("");
    }

    pub async fn block_profile(&self, p: param::BlockProfile) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelBlockProfileParam::default();
        unimplemented!("");
    }

    pub async fn send_message(&self, p: param::SendMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelSendMessageParam::default();
        unimplemented!("");
    }

    pub async fn edit_message(&self, p: param::EditMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelEditMessageParam::default();
        unimplemented!("");
    }

    pub async fn delete_messages(&self, p: param::DeleteMessages) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelDeleteMessagesParam::default();
        unimplemented!("");
    }

    pub async fn like_message(&self, p: param::LikeMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelLikeMessageParam::default();
        unimplemented!("");
    }

    pub async fn un_like_message(&self, p: param::UnLikeMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelUnLikeMessageParam::default();
        unimplemented!("");
    }

    pub async fn re_share_message(&self, p: param::ReShareMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelReShareMessageParam::default();
        unimplemented!("");
    }

    pub async fn un_re_share_message(&self, p: param::UnReShareMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelUnReShareMessageParam::default();
        unimplemented!("");
    }

    pub async fn add_comment(&self, p: param::AddComment) -> Result<pb::Channel,GenErr> {
    ...
    pub async fn pin_message(&self, p: param::PinMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelPinMessageParam::default();
        unimplemented!("");
    }

    pub async fn un_pin_message(&self, p: param::UnPinMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelUnPinMessageParam::default();
        unimplemented!("");
    }

    pub async fn avatar_add(&self, p: param::AvatarAdd) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelAvatarAddParam::default();
        unimplemented!("");
    }

    pub async fn avatar_delete(&self, p: param::AvatarDelete) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelAvatarDeleteParam::default();
        unimplemented!("");
    }

    pub async fn send_doing_action(&self, p: param::SendDoingAction) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelSendDoingActionParam::default();
        unimplemented!("");
    }

    pub async fn report_channel(&self, p: param::ReportChannel) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelReportChannelParam::default();
        unimplemented!("");
    }

    pub async fn report_message(&self, p: param::ReportMessage) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelReportMessageParam::default();
        unimplemented!("");
    }

    pub async fn get_full(&self, p: param::GetFull) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetFullParam::default();
        unimplemented!("");
    }

    pub async fn get_messages_list(&self, p: param::GetMessagesList) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetMessagesListParam::default();
        unimplemented!("");
    }

    pub async fn get_media_list(&self, p: param::GetMediaList) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetMediaListParam::default();
        unimplemented!("");
    }

    pub async fn get_authors(&self, p: param::GetAuthors) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetAuthorsParam::default();
        unimplemented!("");
    }

    pub async fn get_followers(&self, p: param::GetFollowers) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetFollowersParam::default();
        unimplemented!("");
    }

    pub async fn get_subscribers(&self, p: param::GetSubscribers) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetSubscribersParam::default();
        unimplemented!("");
    }

    pub async fn blocked(&self, p: param::Blocked) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelBlockedParam::default();
        unimplemented!("");
    }

    pub async fn avatar_get_list(&self, p: param::AvatarGetList) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelAvatarGetListParam::default();
        unimplemented!("");
    }

    pub async fn get_inbox(&self, p: param::GetInbox) -> Result<pb::Channel,GenErr> {
        let _ = pb::ChannelGetInboxParam::default();
        unimplemented!("");
    }

    pub async fn get_followings(&self, p: param::GetFollowings) -> Result<pb::Channel,GenErr> {
...
/*        
    ...
    pub async fn delete_chat(&self, p: param::DeleteChat) -> Result<pb::Chat,GenErr> {
    ...
    pub async fn delete_messages(&self, p: param::DeleteMessages) -> Result<pb::Chat,GenErr> {
    ...
    pub async fn set_notification(&self, p: param::SetNotification) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatSetNotificationParam::default();
        unimplemented!("");
    }

    pub async fn send_doing_action(&self, p: param::SendDoingAction) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatSendDoingActionParam::default();
        unimplemented!("");
    }

    pub async fn report_chat(&self, p: param::ReportChat) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatReportChatParam::default();
        unimplemented!("");
    }

    pub async fn get_full(&self, p: param::GetFullMessage) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatGetFullMessageParam::default();
        unimplemented!("");
    }

    pub async fn get_messages_list(&self, p: param::GetMessagesList) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatGetMessagesListParam::default();
        unimplemented!("");
    }

    pub async fn get_media_list(&self, p: param::GetMediaList) -> Result<pb::Chat,GenErr> {
        let _ = pb::ChatGetMediaListParam::default();
        unimplemented!("");
    }

    pub async fn get_inbox(&self, p: param::GetInbox) -> Result<pb::Chat,GenErr> {
...
/*        
    ...
    pub async fn create_group(&self, p: param::CreateGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupCreateGroupParam::default();
        unimplemented!("");
    }

    pub async fn edit_group(&self, p: param::EditGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupEditGroupParam::default();
        unimplemented!("");
    }

    pub async fn delete_group(&self, p: param::DeleteGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupDeleteGroupParam::default();
        unimplemented!("");
    }

    pub async fn add_admin(&self, p: param::AddAdmin) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupAddAdminParam::default();
        unimplemented!("");
    }

    pub async fn remove_member(&self, p: param::RemoveMember) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupRemoveMemberParam::default();
        unimplemented!("");
    }

    pub async fn change_member_level(&self, p: param::ChangeMemberLevel) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupChangeMemberLevelParam::default();
        unimplemented!("");
    }

    pub async fn change_member_permission(&self, p: param::ChangeMemberPermission) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupChangeMemberPermissionParam::default();
        unimplemented!("");
    }

    pub async fn ban_member(&self, p: param::BanMember) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupBanMemberParam::default();
        unimplemented!("");
    }

    pub async fn join_group(&self, p: param::JoinGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::JoinGroupParam::default();
        unimplemented!("");
    }

    pub async fn leave_group(&self, p: param::LeaveGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupLeaveGroupParam::default();
        unimplemented!("");
    }

    pub async fn add_member(&self, p: param::AddMember) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupAddMemberParam::default();
        unimplemented!("");
    }

    pub async fn set_notification(&self, p: param::SetNotification) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupSetNotificationParam::default();
        unimplemented!("");
    }

    pub async fn change_privacy(&self, p: param::ChangePrivacy) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupChangePrivacyParam::default();
        unimplemented!("");
    }

    pub async fn change_default_permission(&self, p: param::ChangeDefaultPermission) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupChangeDefaultPermissionParam::default();
        unimplemented!("");
    }

    pub async fn revoke_link(&self, p: param::RevokeLink) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupRevokeLinkParam::default();
        unimplemented!("");
    }

    pub async fn change_username(&self, p: param::ChangeUsername) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupChangeUsernameParam::default();
        unimplemented!("");
    }

    pub async fn send_message(&self, p: param::SendMessage) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupSendMessageParam::default();
        unimplemented!("");
    }

    pub async fn edit_message(&self, p: param::EditMessage) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupEditMessageParam::default();
        unimplemented!("");
    }

    pub async fn delete_messages(&self, p: param::DeleteMessages) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupDeleteMessagesParam::default();
        unimplemented!("");
    }

    pub async fn delete_history(&self, p: param::DeleteHistory) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupDeleteHistoryParam::default();
        unimplemented!("");
    }

    pub async fn pin_message(&self, p: param::PinMessage) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupPinMessageParam::default();
        unimplemented!("");
    }

    pub async fn un_pin_message(&self, p: param::UnPinMessage) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupUnPinMessageParam::default();
        unimplemented!("");
    }

    pub async fn avatar_add(&self, p: param::AvatarAdd) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupAvatarAddParam::default();
        unimplemented!("");
    }

    pub async fn avatar_delete(&self, p: param::AvatarDelete) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupAvatarDeleteParam::default();
        unimplemented!("");
    }

    pub async fn send_doing_action(&self, p: param::SendDoingAction) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupSendDoingActionParam::default();
        unimplemented!("");
    }

    pub async fn report_group(&self, p: param::ReportGroup) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupReportGroupParam::default();
        unimplemented!("");
    }

    pub async fn get_full(&self, p: param::GetFull) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupGetFullParam::default();
        unimplemented!("");
    }

    pub async fn get_messages_list(&self, p: param::GetMessagesList) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupGetMessagesListParam::default();
        unimplemented!("");
    }

    pub async fn get_media_list(&self, p: param::GetMediaList) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupGetMediaListParam::default();
        unimplemented!("");
    }

    pub async fn get_members_list(&self, p: param::GetMembersList) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupGetMembersListParam::default();
        unimplemented!("");
    }

    pub async fn get_admins_list(&self, p: param::GetAdminsList) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupGetAdminsListParam::default();
        unimplemented!("");
    }

    pub async fn avatar_get_list(&self, p: param::AvatarGetList) -> Result<pb::Group,GenErr> {
        let _ = pb::GroupAvatarGetListParam::default();
        unimplemented!("");
    }

    pub async fn get_inbox(&self, p: param::GetInbox) -> Result<pb::Group,GenErr> {
...
/*        
    ...
    pub async fn set_settings(&self, p: param::SetSettings) -> Result<pb::Profile,GenErr> {
...
/*        
    ...
    pub async fn echo(&self, p: param::Echo) -> Result<pb::Shared,GenErr> {
        let _ = pb::SharedEchoParam::default();
        unimplemented!("");
    }

    pub async fn check_user_name(&self, p: param::CheckUserName) -> Result<pb::Shared,GenErr> {
...
/*        
    ...
    pub async fn eee(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn create_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn edit_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn pause_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn terminate_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn add_product(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn edit_product(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn delete_product(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn add_product_to_basket(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn remove_product_from_basket(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn checkout_basket(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn like_product(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn un_like_product(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn like_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn un_like_shop(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_full(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn product_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_basket_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_liked_products_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_liked_shops_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_order_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn get_refund_list(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn cancel_order(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn edit_product_info(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn edit_product_price(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }

    pub async fn edit_product_inventory(&self, p: param::) -> Result<pb::Shop,GenErr> {
        let _ = pb::Param::default();
        unimplemented!("");
    }
...
/*        
    ...
    pub async fn file(&self, p: param::File) -> Result<pb::Upload,GenErr> {
...
/*        
    ...
    pub async fn edit_user(&self, p: param::EditUser) -> Result<pb::User,GenErr> {
        let _ = pb::UserEditUserParam::default();
        unimplemented!("");
    }

    pub async fn delete_send_code(&self, p: param::DeleteSendCode) -> Result<pb::User,GenErr> {
        let _ = pb::UserDeleteSendCodeParam::default();
        unimplemented!("");
    }

    pub async fn delete_confirm_code(&self, p: param::DeleteConfirmCode) -> Result<pb::User,GenErr> {
        let _ = pb::UserDeleteConfirmCodeParam::default();
        unimplemented!("");
    }

    pub async fn delete_user(&self, p: param::DeleteUser) -> Result<pb::User,GenErr> {
        let _ = pb::UserDeleteUserParam::default();
        unimplemented!("");
    }

    pub async fn change_phone_number(&self, p: param::ChangePhoneNumber) -> Result<pb::User,GenErr> {
        let _ = pb::UserChangePhoneNumberParam::default();
        unimplemented!("");
    }

    pub async fn remove_session(&self, p: param::RemoveSession) -> Result<pb::User,GenErr> {
        let _ = pb::UserRemoveSessionParam::default();
        unimplemented!("");
    }

    pub async fn remove_other_sessions(&self, p: param::RemoveOther) -> Result<pb::User,GenErr> {
        let _ = pb::UserRemoveOtherParam::default();
        unimplemented!("");
    }

    pub async fn get_me(&self, p: param::GetMe) -> Result<pb::User,GenErr> {
        let _ = pb::UserGetMeParam::default();
        unimplemented!("");
    }

    pub async fn get_active_sessions(&self, p: param::GetActiveSessions) -> Result<pb::User,GenErr> {
