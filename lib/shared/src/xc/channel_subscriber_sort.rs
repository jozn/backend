...
impl ChannelSubscriberSort {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(),CWError> {
        ...
        let cql_query = format!("INSERT INTO flip.channel_subscriber_sort ({}) VALUES ({})", cql_columns, cql_question);
...
impl ChannelSubscriberSort_Selector {
    ...
    pub fn _get_rows_with_size(&mut self,session: impl FCQueryExecutor, size: i64) -> Result<Vec<ChannelSubscriberSort>, CWError>   {
    ...
    pub fn get_rows(&mut self, session: impl FCQueryExecutor) -> Result<Vec<ChannelSubscriberSort>, CWError>{
        self._get_rows_with_size(session,-1)
    }

    pub fn get_row(&mut self, session: impl FCQueryExecutor) -> Result<ChannelSubscriberSort, CWError>{
...
impl ChannelSubscriberSort_Updater {
    ...
    pub fn update(&mut self,session: impl FCQueryExecutor) -> cdrs::error::Result<Frame>  {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            ...
            format!("UPDATE flip.channel_subscriber_sort SET {} WHERE {}", cql_update, cql_where)
        };
...
impl ChannelSubscriberSort_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(),CWError> {
        ...
        let cql_query = format!("DELETE {} FROM flip.channel_subscriber_sort WHERE {}", del_col, where_str);
...
pub fn get_channel_subscriber_sort_by_channel_cid_and_profile_cid_and_subscriber_gid(session: impl FCQueryExecutor, p1:i64,p2:i64,p3:i64) -> Result<ChannelSubscriberSort,CWError> {
