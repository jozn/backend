...
impl ChannelFollowerSort {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "INSERT INTO flip.channel_follower_sort ({}) VALUES ({})",
...
impl ChannelFollowerSort_Selector {
    ...
    pub fn _get_rows_with_size(
        ...
        size: i64,
    ) -> Result<Vec<ChannelFollowerSort>, CWError> {
    ...
    pub fn get_row(
        &mut self,
        session: impl FCQueryExecutor,
    ) -> Result<ChannelFollowerSort, CWError> {
...
impl ChannelFollowerSort_Updater {
    ...
    pub fn update(&mut self, session: impl FCQueryExecutor) -> cdrs::error::Result<Frame> {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            ...
            format!(
                "UPDATE flip.channel_follower_sort SET {} WHERE {}",
...
impl ChannelFollowerSort_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "DELETE {} FROM flip.channel_follower_sort WHERE {}",
            del_col, where_str
        );
...
pub fn get_channel_follower_sort_by_channel_cid_and_profile_cid_and_follow_gid(
    session: impl FCQueryExecutor,
    p1: i64,
    p2: i64,
    p3: i64,
