...
impl ChannelMsgMedia {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "INSERT INTO flip.channel_msg_media ({}) VALUES ({})",
...
impl ChannelMsgMedia_Selector {
    ...
    pub fn _get_rows_with_size(
        ...
        size: i64,
    ) -> Result<Vec<ChannelMsgMedia>, CWError> {
...
impl ChannelMsgMedia_Updater {
    ...
    pub fn update(&mut self, session: impl FCQueryExecutor) -> cdrs::error::Result<Frame> {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            ...
            format!(
                "UPDATE flip.channel_msg_media SET {} WHERE {}",
...
impl ChannelMsgMedia_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "DELETE {} FROM flip.channel_msg_media WHERE {}",
            del_col, where_str
        );
...
pub fn get_channel_msg_media_by_channel_cid_and_msg_gid_and_media_type_id(
    session: impl FCQueryExecutor,
    p1: i64,
    p2: i64,
    p3: i64,
) -> Result<ChannelMsgMedia, CWError> {
