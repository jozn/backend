...
impl ProfileSubscriberSort {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "INSERT INTO flip.profile_subscriber_sort ({}) VALUES ({})",
...
impl ProfileSubscriberSort_Selector {
    ...
    pub fn _get_rows_with_size(
        ...
        size: i64,
    ) -> Result<Vec<ProfileSubscriberSort>, CWError> {
    ...
    pub fn get_row(
        &mut self,
        session: impl FCQueryExecutor,
    ) -> Result<ProfileSubscriberSort, CWError> {
...
impl ProfileSubscriberSort_Updater {
    ...
    pub fn update(&mut self, session: impl FCQueryExecutor) -> cdrs::error::Result<Frame> {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            ...
            format!(
                "UPDATE flip.profile_subscriber_sort SET {} WHERE {}",
...
impl ProfileSubscriberSort_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "DELETE {} FROM flip.profile_subscriber_sort WHERE {}",
            del_col, where_str
        );
...
pub fn get_profile_subscriber_sort_by_profile_cid_and_channel_cid_and_subscriber_gid(
    session: impl FCQueryExecutor,
    p1: i64,
    p2: i64,
    p3: i64,
