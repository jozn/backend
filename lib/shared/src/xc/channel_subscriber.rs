...
impl ChannelSubscriber {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "INSERT INTO msgs.channel_subscriber ({}) VALUES ({})",
...
impl ChannelSubscriber_Selector {
    ...
    pub fn _to_cql(&self) -> (String, Vec<Value>) {
        ...
        let mut cql_query = format!("SELECT {} FROM msgs.channel_subscriber", cql_select);
...
impl ChannelSubscriber_Updater {
    ...
    pub fn update(&mut self, session: impl FCQueryExecutor) -> cdrs::error::Result<Frame> {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            format!("UPDATE msgs.channel_subscriber SET {}", cql_update)
        } else {
            format!(
                "UPDATE msgs.channel_subscriber SET {} WHERE {}",
...
impl ChannelSubscriber_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "DELETE {} FROM msgs.channel_subscriber WHERE {}",
            del_col, where_str
        );
        //let cql_query = "DELETE " + del_col + " FROM msgs.channel_subscriber WHERE " + where_str ;
...
pub fn get_channel_subscriber_by_channel_cid_and_profile_cid(
    session: impl FCQueryExecutor,
    p1: i64,
    p2: i64,
