...
impl ProfileFollower {
    pub fn save(&self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "INSERT INTO flip.profile_follower ({}) VALUES ({})",
...
impl ProfileFollower_Selector {
    ...
    pub fn _get_rows_with_size(
        ...
        size: i64,
    ) -> Result<Vec<ProfileFollower>, CWError> {
...
impl ProfileFollower_Updater {
    ...
    pub fn update(&mut self, session: impl FCQueryExecutor) -> cdrs::error::Result<Frame> {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            ...
            format!(
                "UPDATE flip.profile_follower SET {} WHERE {}",
...
impl ProfileFollower_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(), CWError> {
        ...
        let cql_query = format!(
            "DELETE {} FROM flip.profile_follower WHERE {}",
            del_col, where_str
        );
...
pub fn get_profile_follower_by_profile_cid_and_follow_gid_and_channel_cid(
    session: impl FCQueryExecutor,
    p1: i64,
    p2: i64,
    p3: i64,
) -> Result<ProfileFollower, CWError> {
