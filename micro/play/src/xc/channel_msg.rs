...
impl ChannelMsg {
    ...
    pub fn save(&mut self, session: impl FCQueryExecutor) -> Result<(),CWError> {
        ...
        let cql_query = format!("INSERT INTO msgs.channel_msg ({}) VALUES ({})", cql_columns, cql_question);
...
impl ChannelMsg_Selector {
    ...
    pub fn _to_cql(&self) ->  (String, Vec<Value>)  {
        ...
        let mut cql_query = format!("SELECT {} FROM msgs.channel_msg", cql_select);
...
impl ChannelMsg_Updater {
    ...
    pub fn update(&mut self,session: impl FCQueryExecutor) -> cdrs::error::Result<Frame>  {
        ...
        let mut cql_query = if self.wheres.is_empty() {
            format!("UPDATE msgs.channel_msg SET {}", cql_update)
        } else {
            format!("UPDATE msgs.channel_msg SET {} WHERE {}", cql_update, cql_where)
        };
...
impl ChannelMsg_Deleter {
    ...
    pub fn delete(&mut self, session: impl FCQueryExecutor) -> Result<(),CWError> {
        ...
        let cql_query = format!("DELETE {} FROM msgs.channel_msg WHERE {}", del_col, where_str);
        //let cql_query = "DELETE " + del_col + " FROM msgs.channel_msg WHERE " + where_str ;
