// Automatically generated rust module for 'pb_views.proto' file
...
pub struct PB_MediaView { }

impl<'a> MessageRead<'a> for PB_MediaView {
...
impl MessageWrite for PB_MediaView { }

#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_ActionView {
    pub ActionId: i64,
    pub ActorUserId: i32,
    ...
    pub CreatedTime: i32,
    pub ActorUserView: Option<PB_UserView>,
    pub PostView: Option<PB_PostView>,
    pub CommentView: Option<PB_CommentView>,
    pub FollowedUserView: Option<PB_UserView>,
    pub ContentOwenerUserView: Option<PB_UserView>,
}

impl<'a> MessageRead<'a> for PB_ActionView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        ...
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(802) => msg.ActorUserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(810) => msg.PostView = Some(r.read_message::<PB_PostView>(bytes)?),
                Ok(818) => msg.CommentView = Some(r.read_message::<PB_CommentView>(bytes)?),
                Ok(826) => msg.FollowedUserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(834) => msg.ContentOwenerUserView = Some(r.read_message::<PB_UserView>(bytes)?),
...
impl MessageWrite for PB_ActionView {
...
impl<'a> MessageRead<'a> for PB_NotifyView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_NotifyView {
    fn get_size(&self) -> usize {
        0
...
pub struct PB_CommentView {
    ...
    pub LikesCount: i32,
    pub CreatedTime: i32,
    pub SenderUserView: Option<PB_UserView>,
}

impl<'a> MessageRead<'a> for PB_CommentView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(122) => msg.SenderUserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_CommentView {
    fn get_size(&self) -> usize {
        0
        + if self.CommentId == 0i64 { 0 } else { 1 + sizeof_varint(*(&self.CommentId) as u64) }
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_PostView {
    pub PostId: i64,
    pub UserId: i32,
    pub PostTypeEnum: pb_enum::PostTypeEnum,
    pub Text: String,
    pub RichText: String,
    pub MediaCount: i32,
    pub SharedTo: i32,
    ...
    pub SenderUserView: Option<PB_UserView>,
    pub ReSharedUserView: Option<PB_UserView>,
    pub MediaView: Option<PB_MediaView>,
    pub MediaViewList: Vec<PB_MediaView>,
}

impl<'a> MessageRead<'a> for PB_PostView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(802) => msg.SenderUserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(810) => msg.ReSharedUserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(818) => msg.MediaView = Some(r.read_message::<PB_MediaView>(bytes)?),
                Ok(826) => msg.MediaViewList.push(r.read_message::<PB_MediaView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_PostView {
    fn get_size(&self) -> usize {
        0
        + if self.PostId == 0i64 { 0 } else { 1 + sizeof_varint(*(&self.PostId) as u64) }
        + if self.UserId == 0i32 { 0 } else { 1 + sizeof_varint(*(&self.UserId) as u64) }
        + if self.PostTypeEnum == pb_enum::PostTypeEnum::POST_Type_Unknown { 0 } else { 1 + sizeof_varint(*(&self.PostTypeEnum) as u64) }
        + if self.Text == String::default() { 0 } else { 1 + sizeof_len((&self.Text).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.UserId != 0i32 { w.write_with_tag(16, |w| w.write_int32(*&self.UserId))?; }
        if self.PostTypeEnum != pb_enum::PostTypeEnum::POST_Type_Unknown { w.write_with_tag(24, |w| w.write_enum(*&self.PostTypeEnum as i32))?; }
        if self.Text != String::default() { w.write_with_tag(34, |w| w.write_string(&**&self.Text))?; }
...
pub struct PB_ChatView {
    ...
    pub IsMute: i32,
    pub UserView: Option<PB_UserView>,
    pub GroupView: Option<PB_GroupView>,
    pub FirstUnreadMessage: Option<PB_MessageView>,
    pub LastMessage: Option<PB_MessageView>,
}

impl<'a> MessageRead<'a> for PB_ChatView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(802) => msg.UserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(810) => msg.GroupView = Some(r.read_message::<PB_GroupView>(bytes)?),
                Ok(1602) => msg.FirstUnreadMessage = Some(r.read_message::<PB_MessageView>(bytes)?),
                Ok(1610) => msg.LastMessage = Some(r.read_message::<PB_MessageView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_ChatView {
    fn get_size(&self) -> usize {
        0
...
impl<'a> MessageRead<'a> for PB_GroupView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_GroupView {
    fn get_size(&self) -> usize {
        0
        + if self.GroupId == 0i64 { 0 } else { 1 + sizeof_varint(*(&self.GroupId) as u64) }
...
impl<'a> MessageRead<'a> for PB_GroupMemberView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_GroupMemberView {
    fn get_size(&self) -> usize {
        0
...
pub struct PB_MessageView {
    ...
    pub EditTime: i32,
    pub Ttl: i32,
    pub FileRedView: Option<PB_FileRedView>,
}

impl<'a> MessageRead<'a> for PB_MessageView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(402) => msg.FileRedView = Some(r.read_message::<PB_FileRedView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_MessageView {
    fn get_size(&self) -> usize {
        0
        + if self.RoomKey == String::default() { 0 } else { 1 + sizeof_len((&self.RoomKey).len()) }
...
impl<'a> MessageRead<'a> for PB_FileRedView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_FileRedView {
    fn get_size(&self) -> usize {
        0
        + if self.FileRefId == 0i64 { 0 } else { 1 + sizeof_varint(*(&self.FileRefId) as u64) }
...
pub struct PB_UserView {
    ...
    pub PostsCount: i32,
    pub MediaCount: i32,
    pub UserOnlineStatusEnum: pb_enum::UserOnlineStatusEnum,
    pub LastActiveTime: i32,
    pub LastActiveTimeShow: String,
    pub MyFollwing: pb_enum::FollowingEnum,
}

impl<'a> MessageRead<'a> for PB_UserView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_UserView {
    fn get_size(&self) -> usize {
        0
        + if self.UserId == 0i32 { 0 } else { 1 + sizeof_varint(*(&self.UserId) as u64) }
        + if self.UserName == String::default() { 0 } else { 1 + sizeof_len((&self.UserName).len()) }
        ...
        + if self.UserOnlineStatusEnum == pb_enum::UserOnlineStatusEnum::EXACTLY { 0 } else { 2 + sizeof_varint(*(&self.UserOnlineStatusEnum) as u64) }
        ...
        + if self.MyFollwing == pb_enum::FollowingEnum::FOLLOWING_NONE { 0 } else { 2 + sizeof_varint(*(&self.MyFollwing) as u64) }
    }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.UserOnlineStatusEnum != pb_enum::UserOnlineStatusEnum::EXACTLY { w.write_with_tag(1600, |w| w.write_enum(*&self.UserOnlineStatusEnum as i32))?; }
        ...
        if self.MyFollwing != pb_enum::FollowingEnum::FOLLOWING_NONE { w.write_with_tag(2400, |w| w.write_enum(*&self.MyFollwing as i32))?; }
        Ok(())
    }
}

#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_SettingNotificationView { }

impl<'a> MessageRead<'a> for PB_SettingNotificationView {
    fn from_reader(r: &mut BytesReader, _: &[u8]) -> Result<Self> {
        r.read_to_end();
        Ok(Self::default())
    }
...
impl MessageWrite for PB_SettingNotificationView { }

#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_AppConfig {
    pub DeprecatedClient: bool,
    pub HasNewUpdate: bool,
}

impl<'a> MessageRead<'a> for PB_AppConfig {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_AppConfig {
    fn get_size(&self) -> usize {
        0
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_UserProfileView { }

impl<'a> MessageRead<'a> for PB_UserProfileView {
    fn from_reader(r: &mut BytesReader, _: &[u8]) -> Result<Self> {
        r.read_to_end();
        Ok(Self::default())
    }
...
impl MessageWrite for PB_UserProfileView { }

#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_UserViewRowify {
    pub Id: i64,
    pub CreatedTime: i32,
    pub UserView: Option<PB_UserView>,
}

impl<'a> MessageRead<'a> for PB_UserViewRowify {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(82) => msg.UserView = Some(r.read_message::<PB_UserView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_UserViewRowify {
    fn get_size(&self) -> usize {
        0
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_PostViewRowify {
    pub Id: i64,
    pub PostView: Option<PB_PostView>,
}

impl<'a> MessageRead<'a> for PB_PostViewRowify {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(8) => msg.Id = r.read_int64(bytes)?,
                Ok(82) => msg.PostView = Some(r.read_message::<PB_PostView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_PostViewRowify {
    fn get_size(&self) -> usize {
        0
        + if self.Id == 0i64 { 0 } else { 1 + sizeof_varint(*(&self.Id) as u64) }
...
impl<'a> MessageRead<'a> for PB_TagView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_TagView {
    fn get_size(&self) -> usize {
        0
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PB_TopTagWithSamplePosts {
    pub TagView: Option<PB_TagView>,
    pub PostViewList: Vec<PB_PostView>,
}

impl<'a> MessageRead<'a> for PB_TopTagWithSamplePosts {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.TagView = Some(r.read_message::<PB_TagView>(bytes)?),
                Ok(18) => msg.PostViewList.push(r.read_message::<PB_PostView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_TopTagWithSamplePosts {
    fn get_size(&self) -> usize {
        0
...
pub struct PB_SelfUserView {
    ...
    pub SettingNotification: Option<PB_SettingNotificationView>,
}

impl<'a> MessageRead<'a> for PB_SelfUserView {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.UserView = Some(r.read_message::<PB_UserView>(bytes)?),
                ...
                Ok(802) => msg.SettingNotification = Some(r.read_message::<PB_SettingNotificationView>(bytes)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl MessageWrite for PB_SelfUserView {
    fn get_size(&self) -> usize {
        0
        + self.UserView.as_ref().map_or(0, |m| 1 + sizeof_len((m).get_size()))
...
impl<'a> MessageRead<'a> for PB_Error {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl MessageWrite for PB_Error {
    fn get_size(&self) -> usize {
        0
        + if self.Error == pb_views::ServerErrors::UNKNOWN_ERR { 0 } else { 1 + sizeof_varint(*(&self.Error) as u64) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        if self.Error != pb_views::ServerErrors::UNKNOWN_ERR { w.write_with_tag(8, |w| w.write_enum(*&self.Error as i32))?; }
