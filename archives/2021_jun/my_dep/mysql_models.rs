...
impl Channel {
    pub async fn replace(&self, pool: &Pool) -> Result<Channel,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel (channel_cid, pb_data, debug_data) VALUES (?, ?, ?)";
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel SET pb_data = ?, debug_data = ? WHERE channel_cid = ? ";
        let p = Params::Positional(vec![self.pb_data.clone().into(), self.debug_data.clone().into(),  self.channel_cid.clone().into() ]);
...
impl ChannelSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Channel>, MyError>   {
...
impl ChannelFollower {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelFollower,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel_follower (profile_cid, channel_cid, created_time, follow_id) VALUES (?, ?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.channel_cid.clone().into(), self.created_time.clone().into(), self.follow_id.clone().into()]);
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelFollower,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.channel_follower (profile_cid, channel_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.channel_cid.clone().into(), self.created_time.clone().into(), self.follow_id.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel_follower SET created_time = ?, follow_id = ? WHERE profile_cid = ? AND channel_cid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.created_time.clone().into(), self.follow_id.clone().into(),  self.channel_cid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.channel_follower WHERE profile_cid = ? AND channel_cid = ? ";
        let p = Params::Positional(vec![self.channel_cid.clone().into()]);
...
impl ChannelFollowerSelector {
    ...
    pub fn select_follow_id(&mut self) -> &mut Self {
        self.select_cols.push("follow_id");
        self
    }
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelFollower>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
    ...
    pub fn order_by_follow_id_asc(&mut self) -> &mut Self {
		self.order_by.push("follow_id ASC");
        self
    }

	pub fn order_by_follow_id_desc(&mut self) -> &mut Self {
		self.order_by.push("follow_id DESC");
        self
    }
...
#[derive(Debug, PartialEq, Eq, Clone)]
pub struct ChannelMessageLike  { // channel_message_like
    pub message_gid: u64,
    pub profile_cid: u64,
}

impl FromRow for ChannelMessageLike {
    fn from_row_opt(row: Row) -> Result<Self, FromRowError>
    where
        Self: Sized,
    {
        Ok(ChannelMessageLike  {
...
impl ChannelMessageLike {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelMessageLike,MyError> {
        let mut conn = pool.get_conn().await?;

        let query = r"REPLACE INTO flip_my.channel_message_like (message_gid, profile_cid) VALUES (?, ?)";
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelMessageLike,MyError> {
        let mut conn = pool.get_conn().await?;
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel_message_like SET  WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.message_gid.clone().into(),  self.profile_cid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.channel_message_like WHERE message_gid = ? AND profile_cid = ? ";
...
#[derive(Default, Debug)]
pub struct ChannelMessageLikeSelector {
    wheres: Vec<WhereClause>,
    select_cols: Vec<&'static str>,
    order_by:  Vec<&'static str>,
    limit: u32,
...
impl ChannelMessageLikeSelector {
    pub fn new() -> Self {
        ChannelMessageLikeSelector::default()
    }
    ...
    fn _to_cql(&self) ->  (String, Vec<Value>)  {
        ...
        let mut cql_query = format!("SELECT {} FROM flip_my.channel_message_like", cql_select);
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelMessageLike>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
        ...
        let query_result = conn
            .exec_map(
                cql_query,p,
                |obj: ChannelMessageLike| obj
            ).await?;

        Ok(query_result)
    }

    pub async fn get_rows(&mut self, session: &Pool) -> Result<Vec<ChannelMessageLike>, MyError>{
        self._get_rows_with_size(session,-1).await
    }

    pub async fn get_row(&mut self, session: &Pool) -> Result<ChannelMessageLike, MyError>{
        let rows = self._get_rows_with_size(session,1).await?;
...
impl ChannelMsg {
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into(),  self.msg_gid.clone().into() ]);
...
impl ChannelMsgSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelMsg>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl ChannelMsgLike {
    pub async fn replace(&self, pool: &Pool) -> Result<ChannelMsgLike,MyError> {
        let mut conn = pool.get_conn().await?;

        let query = r"REPLACE INTO flip_my.channel_msg_like (message_gid, profile_cid, created_time) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.profile_cid.clone().into(), self.created_time.clone().into()]);
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChannelMsgLike,MyError> {
        let mut conn = pool.get_conn().await?;

        let query = r"REPLACE INTO flip_my.channel_msg_like (message_gid, profile_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.profile_cid.clone().into(), self.created_time.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.channel_msg_like SET created_time = ? WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.created_time.clone().into(),  self.profile_cid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.channel_msg_like WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into()]);
...
impl ChannelMsgLikeSelector {
    pub fn new() -> Self {
        ChannelMsgLikeSelector::default()
    }
    ...
    fn _to_cql(&self) ->  (String, Vec<Value>)  {
        ...
        let mut cql_query = format!("SELECT {} FROM flip_my.channel_msg_like", cql_select);
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelMsgLike>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
    ...
    pub async fn get_rows(&mut self, session: &Pool) -> Result<Vec<ChannelMsgLike>, MyError>{
        self._get_rows_with_size(session,-1).await
    }

    pub async fn get_row(&mut self, session: &Pool) -> Result<ChannelMsgLike, MyError>{
        let rows = self._get_rows_with_size(session,1).await?;
...
impl ChannelMsgMediaSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelMsgMedia>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl ChannelSubscriberSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChannelSubscriber>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl Chat {
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into(),  self.chat_gid.clone().into() ]);
...
impl ChatSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Chat>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl ChatMsg {
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<ChatMsg,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.chat_msg (profile_cid, chat_gid, msg_gid) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.chat_gid.clone().into(), self.msg_gid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.chat_gid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into(),  self.msg_gid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.chat_msg WHERE profile_cid = ? AND chat_gid = ? AND msg_gid = ? ";
        let p = Params::Positional(vec![self.msg_gid.clone().into()]);
...
impl ChatMsgSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ChatMsg>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl Direct {
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<Direct,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.direct (profile_cid, direct_gid, msg_gid) VALUES (?, ?, ?)";
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.direct_gid.clone().into(), self.msg_gid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into()]);
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.direct_gid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into(),  self.msg_gid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.direct WHERE profile_cid = ? AND direct_gid = ? AND msg_gid = ? ";
        let p = Params::Positional(vec![self.msg_gid.clone().into()]);
...
impl DirectSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Direct>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl FileSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<File>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl FileRefSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<FileRef>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl GenCidSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<GenCid>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl MsgComment {
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let p = Params::Positional(vec![self.channel_cid.clone().into(), self.message_gid.clone().into(), self.pb_data.clone().into(), self.debug_data.clone().into(),  self.comment_gid.clone().into() ]);
...
impl MsgCommentSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<MsgComment>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
#[derive(Debug, PartialEq, Eq, Clone)]
pub struct MsgLike2  { // msg_like2
    pub message_gid: u64,
    pub profile_cid: u64,
}

impl FromRow for MsgLike2 {
    fn from_row_opt(row: Row) -> Result<Self, FromRowError>
    where
        Self: Sized,
    {
...
impl MsgLike2 {
    pub async fn replace(&self, pool: &Pool) -> Result<MsgLike2,MyError> {
        let mut conn = pool.get_conn().await?;

        let query = r"REPLACE INTO flip_my.msg_like2 (message_gid, profile_cid) VALUES (?, ?)";
        let p = Params::Positional(vec![self.message_gid.clone().into(), self.profile_cid.clone().into()]);
    ...
    pub async fn replace_dep(&self, pool: &Pool) -> Result<MsgLike2,MyError> {
        let mut conn = pool.get_conn().await?;
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.msg_like2 SET  WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.message_gid.clone().into(),  self.profile_cid.clone().into() ]);
    ...
    pub async fn delete(&self, pool: &Pool) -> Result<(),MyError> {
        ...
        let query = r"DELETE FROM flip_my.msg_like2 WHERE message_gid = ? AND profile_cid = ? ";
        let p = Params::Positional(vec![self.profile_cid.clone().into()]);
...
impl MsgLike2Selector {
    pub fn new() -> Self {
        MsgLike2Selector::default()
    }
    ...
    fn _to_cql(&self) ->  (String, Vec<Value>)  {
        ...
        let mut cql_query = format!("SELECT {} FROM flip_my.msg_like2", cql_select);
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<MsgLike2>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
    ...
    pub async fn get_rows(&mut self, session: &Pool) -> Result<Vec<MsgLike2>, MyError>{
        self._get_rows_with_size(session,-1).await
    }

    pub async fn get_row(&mut self, session: &Pool) -> Result<MsgLike2, MyError>{
        let rows = self._get_rows_with_size(session,1).await?;
...
impl MsgReshareSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<MsgReshare>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl Profile {
    pub async fn replace(&self, pool: &Pool) -> Result<Profile,MyError> {
        ...
        let query = r"REPLACE INTO flip_my.profile (profile_cid, pb_data, debug_data) VALUES (?, ?, ?)";
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.profile SET pb_data = ?, debug_data = ? WHERE profile_cid = ? ";
...
impl ProfileSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Profile>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl ProfileFollowerSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ProfileFollower>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl ProfileSubscriber {
    pub async fn replace(&self, pool: &Pool) -> Result<ProfileSubscriber,MyError> {
        ...
        let p = Params::Positional(vec![self.profile_cid.clone().into(), self.channel_cid.clone().into(), self.subscriber_gid.clone().into()]);
...
impl ProfileSubscriberSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<ProfileSubscriber>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl SessionSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Session>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl Sms {
    pub async fn insert(&self, pool: &Pool) -> Result<Sms,MyError> {
        ...
        let query = r"INSERT INTO flip_my.sms (phone_number, hash_code, result_code, pb_data, debug_data) VALUES (?, ?, ?, ?, ?)";
    ...
    pub async fn update(&self, pool: &Pool) -> Result<(),MyError> {
        let mut conn = pool.get_conn().await?;
        let query = r"UPDATE flip_my.sms SET phone_number = ?, hash_code = ?, result_code = ?, pb_data = ?, debug_data = ? WHERE sms_id = ? ";
...
impl SmsSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<Sms>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
...
impl UserSelector {
    ...
    pub async fn _get_rows_with_size(&mut self, session: &Pool, size: i64) -> Result<Vec<User>, MyError>   {
        let mut conn = session.get_conn().await?;
        let(cql_query, query_values) = self._to_cql();
