// Automatically generated rust module for 'pb_enum.proto' file
...
impl From<i32> for UserTypeEnum {
    fn from(i: i32) -> Self {
        match i {
            0 => UserTypeEnum::USER,
            1 => UserTypeEnum::CHANNEL,
            _ => Self::default(),
        }
    }
}

impl<'a> From<&'a str> for UserTypeEnum {
    fn from(s: &'a str) -> Self {
        match s {
            "USER" => UserTypeEnum::USER,
            "CHANNEL" => UserTypeEnum::CHANNEL,
            _ => Self::default(),
        }
    }
}
...
#[derive(Debug, PartialEq, Eq, Clone, Copy)]
pub enum ProfilePrivacyLevelEnum {
    NONE = 0,
}

impl Default for ProfilePrivacyLevelEnum {
    fn default() -> Self {
        ProfilePrivacyLevelEnum::NONE
    }
}

impl From<i32> for ProfilePrivacyLevelEnum {
    fn from(i: i32) -> Self {
        match i {
            0 => ProfilePrivacyLevelEnum::NONE,
            _ => Self::default(),
        }
    }
}

impl<'a> From<&'a str> for ProfilePrivacyLevelEnum {
    fn from(s: &'a str) -> Self {
        match s {
            "NONE" => ProfilePrivacyLevelEnum::NONE,
            _ => Self::default(),
        }
    }
}
...
impl Default for RoomTypeEnum {
    fn default() -> Self {
        RoomTypeEnum::UNKNOWN_ROOM_TYPE
    }
}

impl From<i32> for RoomTypeEnum {
    fn from(i: i32) -> Self {
        match i {
            0 => RoomTypeEnum::UNKNOWN_ROOM_TYPE,
            1 => RoomTypeEnum::DIRECT,
            2 => RoomTypeEnum::GROUP,
            3 => RoomTypeEnum::BROADCAST,
            _ => Self::default(),
        }
    }
}

impl<'a> From<&'a str> for RoomTypeEnum {
    fn from(s: &'a str) -> Self {
        match s {
            "UNKNOWN_ROOM_TYPE" => RoomTypeEnum::UNKNOWN_ROOM_TYPE,
            "DIRECT" => RoomTypeEnum::DIRECT,
            "GROUP" => RoomTypeEnum::GROUP,
            "BROADCAST" => RoomTypeEnum::BROADCAST,
            _ => Self::default(),
        }
    }
}
...
#[derive(Debug, PartialEq, Eq, Clone, Copy)]
pub enum RoomMessageDeliviryStatusEnum {
...
impl Default for RoomMessageDeliviryStatusEnum {
    fn default() -> Self {
        RoomMessageDeliviryStatusEnum::UNKNOWN_MESSAGE_DELIVIRY
    }
}

impl From<i32> for RoomMessageDeliviryStatusEnum {
    fn from(i: i32) -> Self {
        match i {
            0 => RoomMessageDeliviryStatusEnum::UNKNOWN_MESSAGE_DELIVIRY,
            1 => RoomMessageDeliviryStatusEnum::NEED_TO_SINK,
            2 => RoomMessageDeliviryStatusEnum::FAILED,
            3 => RoomMessageDeliviryStatusEnum::SENDING,
            4 => RoomMessageDeliviryStatusEnum::SENT,
            5 => RoomMessageDeliviryStatusEnum::DELIVERED,
            6 => RoomMessageDeliviryStatusEnum::SEEN,
            _ => Self::default(),
        }
    }
}

impl<'a> From<&'a str> for RoomMessageDeliviryStatusEnum {
    fn from(s: &'a str) -> Self {
        match s {
            "UNKNOWN_MESSAGE_DELIVIRY" => RoomMessageDeliviryStatusEnum::UNKNOWN_MESSAGE_DELIVIRY,
            "NEED_TO_SINK" => RoomMessageDeliviryStatusEnum::NEED_TO_SINK,
            "FAILED" => RoomMessageDeliviryStatusEnum::FAILED,
            "SENDING" => RoomMessageDeliviryStatusEnum::SENDING,
            "SENT" => RoomMessageDeliviryStatusEnum::SENT,
            "DELIVERED" => RoomMessageDeliviryStatusEnum::DELIVERED,
            "SEEN" => RoomMessageDeliviryStatusEnum::SEEN,
            _ => Self::default(),
        }
    }
}
