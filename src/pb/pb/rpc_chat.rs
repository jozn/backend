...
pub struct DeleteChatParam { }

impl<'a> MessageRead<'a> for DeleteChatParam {
...
impl MessageWrite for DeleteChatParam { }
...
impl<'a> MessageRead<'a> for DeleteChatResponse {
...
impl MessageWrite for DeleteChatResponse {
