...
use crate::{com, com::*, pb, pb::sys::Invoke};
...
pub mod rpc {
    ...
    pub fn ChannelGetFull(
        up: &UserParam,
        param: pb::ChannelGetFullMessageParam,
    ) -> Result<pb::ChannelGetFullMessageResponse, GenErr> {
    ...
    pub fn DeleteChat(
        up: &UserParam,
        param: pb::DeleteChatParam,
    ) -> Result<pb::DeleteChatResponse, GenErr> {
        Ok(pb::DeleteChatResponse::default())
    }

    // service: RPC_Direct
    pub fn DirectAddMessage(
        up: &UserParam,
        param: pb::DirectAddMessageParam,
    ) -> Result<pb::DirectAddMessageResponse, GenErr> {
    ...
    pub fn AddComment(
        up: &UserParam,
        param: pb::AddCommentParam,
    ) -> Result<pb::AddCommentResponse, GenErr> {
        Ok(pb::AddCommentResponse::default())
    }
    pub fn DeleteComment(
        up: &UserParam,
        param: pb::DeleteCommentParam,
    ) -> Result<pb::DeleteCommentResponse, GenErr> {
        Ok(pb::DeleteCommentResponse::default())
    }
    pub fn EditComment(
        up: &UserParam,
        param: pb::EditCommentParam,
    ) -> Result<pb::EditCommentResponse, GenErr> {
        Ok(pb::EditCommentResponse::default())
    }
    pub fn LikeComment(
        up: &UserParam,
        param: pb::LikeCommentParam,
    ) -> Result<pb::LikeCommentResponse, GenErr> {
        Ok(pb::LikeCommentResponse::default())
    }
    pub fn AddSeenPosts(
        up: &UserParam,
        param: pb::AddSeenPostsParam,
    ) -> Result<pb::AddSeenPostsResponse, GenErr> {
        Ok(pb::AddSeenPostsResponse::default())
    }
    pub fn LikePost(
        up: &UserParam,
        param: pb::LikePostParam,
    ) -> Result<pb::LikePostResponse, GenErr> {
        Ok(pb::LikePostResponse::default())
    }
    pub fn UnLikePost(
        up: &UserParam,
        param: pb::UnLikePostParam,
    ) -> Result<pb::UnLikePostResponse, GenErr> {
        Ok(pb::UnLikePostResponse::default())
    }
    pub fn FollowChannel(
        up: &UserParam,
        param: pb::FollowChannelParam,
    ) -> Result<pb::FollowChannelResponse, GenErr> {
        Ok(pb::FollowChannelResponse::default())
    }
    pub fn UnFollowChannel(
        up: &UserParam,
        param: pb::UnFollowChannelParam,
    ) -> Result<pb::UnFollowChannelResponse, GenErr> {
        Ok(pb::UnFollowChannelResponse::default())
    }
    pub fn PinChannel(
        up: &UserParam,
        param: pb::PinChannelParam,
    ) -> Result<pb::PinChannelResponse, GenErr> {
        Ok(pb::PinChannelResponse::default())
    }
    pub fn UnPinChannel(
        up: &UserParam,
        param: pb::UnPinChannelParam,
    ) -> Result<pb::UnPinChannelResponse, GenErr> {
        Ok(pb::UnPinChannelResponse::default())
    }
    pub fn BlockChannel(
        up: &UserParam,
        param: pb::BlockChannelParam,
    ) -> Result<pb::BlockChannelResponse, GenErr> {
        Ok(pb::BlockChannelResponse::default())
    }
    pub fn UnBlockChannel(
        up: &UserParam,
        param: pb::UnBlockChannelParam,
    ) -> Result<pb::UnBlockChannelResponse, GenErr> {
