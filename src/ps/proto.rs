...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct RoomMessageContact<'a> {
    pub first_name: Cow<'a, str>,
    pub last_name: Cow<'a, str>,
    pub nickname: Cow<'a, str>,
    pub phone: Vec<Cow<'a, str>>,
    pub email: Vec<Cow<'a, str>>,
}

impl<'a> MessageRead<'a> for RoomMessageContact<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.first_name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(18) => msg.last_name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(26) => msg.nickname = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(34) => msg.phone.push(r.read_string(bytes).map(Cow::Borrowed)?),
                Ok(42) => msg.email.push(r.read_string(bytes).map(Cow::Borrowed)?),
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for RoomMessageContact<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.first_name == "" { 0 } else { 1 + sizeof_len((&self.first_name).len()) }
        + if self.last_name == "" { 0 } else { 1 + sizeof_len((&self.last_name).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        if self.first_name != "" { w.write_with_tag(10, |w| w.write_string(&**&self.first_name))?; }
        if self.last_name != "" { w.write_with_tag(18, |w| w.write_string(&**&self.last_name))?; }
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct RoomMessageContactOwnedInner {
                buf: Vec<u8>,
                proto: RoomMessageContact<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl RoomMessageContactOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    ...
                    let proto = RoomMessageContact::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, RoomMessageContact<'static>>(proto);
            ...
            pub struct RoomMessageContactOwned {
                inner: core::pin::Pin<Box<RoomMessageContactOwnedInner>>,
            }

            #[allow(dead_code)]
            impl RoomMessageContactOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &RoomMessageContact {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RoomMessageContactOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RoomMessageContactOwned {
                type Target = RoomMessageContact<'static>;
            ...
            impl DerefMut for RoomMessageContactOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RoomMessageContactOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RoomMessageContactOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<RoomMessageContact<'a>> for RoomMessageContactOwned {
                fn from(proto: RoomMessageContact) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RoomMessageContactOwnedInner::new(buf).unwrap() }
                }
            }
            
#[derive(Debug, Default, PartialEq, Clone)]
pub struct RoomMessageWallet<'a> {
    pub type_pb: proto::mod_RoomMessageWallet::Type,
    pub money_transfer: Option<proto::mod_RoomMessageWallet::MoneyTransfer<'a>>,
}

impl<'a> MessageRead<'a> for RoomMessageWallet<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for RoomMessageWallet<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct RoomMessageWalletOwnedInner {
                buf: Vec<u8>,
                proto: RoomMessageWallet<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl RoomMessageWalletOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = RoomMessageWallet::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, RoomMessageWallet<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct RoomMessageWalletOwned {
                inner: core::pin::Pin<Box<RoomMessageWalletOwnedInner>>,
            }

            #[allow(dead_code)]
            impl RoomMessageWalletOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &RoomMessageWallet {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RoomMessageWalletOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RoomMessageWalletOwned {
                type Target = RoomMessageWallet<'static>;
            ...
            impl DerefMut for RoomMessageWalletOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RoomMessageWalletOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RoomMessageWalletOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<RoomMessageWallet<'a>> for RoomMessageWalletOwned {
                fn from(proto: RoomMessageWallet) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RoomMessageWalletOwnedInner::new(buf).unwrap() }
                }
            }
...
impl<'a> MessageRead<'a> for MoneyTransfer<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for MoneyTransfer<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct MoneyTransferOwnedInner {
                buf: Vec<u8>,
                proto: MoneyTransfer<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl MoneyTransferOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = MoneyTransfer::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, MoneyTransfer<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct MoneyTransferOwned {
                inner: core::pin::Pin<Box<MoneyTransferOwnedInner>>,
            }

            #[allow(dead_code)]
            impl MoneyTransferOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &MoneyTransfer {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for MoneyTransferOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for MoneyTransferOwned {
                type Target = MoneyTransfer<'static>;
            ...
            impl DerefMut for MoneyTransferOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for MoneyTransferOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: MoneyTransferOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<MoneyTransfer<'a>> for MoneyTransferOwned {
                fn from(proto: MoneyTransfer) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: MoneyTransferOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct RegisteredUser<'a> {
    ...
    pub avatar: Option<proto::Avatar<'a>>,
    pub mutual: bool,
    pub deleted: bool,
    pub cache_id: Cow<'a, str>,
    pub bio: Cow<'a, str>,
    pub verified: bool,
    pub bot: bool,
}

impl<'a> MessageRead<'a> for RegisteredUser<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(34) => msg.first_name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(42) => msg.last_name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(50) => msg.display_name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(58) => msg.initials = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(66) => msg.color = r.read_string(bytes).map(Cow::Borrowed)?,
                ...
                Ok(122) => msg.cache_id = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(130) => msg.bio = r.read_string(bytes).map(Cow::Borrowed)?,
...
impl<'a> MessageWrite for RegisteredUser<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.id == 0u64 { 0 } else { 1 + sizeof_varint(*(&self.id) as u64) }
        ...
        + if self.initials == "" { 0 } else { 1 + sizeof_len((&self.initials).len()) }
        ...
        + if self.cache_id == "" { 0 } else { 1 + sizeof_len((&self.cache_id).len()) }
        + if self.bio == "" { 0 } else { 2 + sizeof_len((&self.bio).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.first_name != "" { w.write_with_tag(34, |w| w.write_string(&**&self.first_name))?; }
        if self.last_name != "" { w.write_with_tag(42, |w| w.write_string(&**&self.last_name))?; }
        if self.display_name != "" { w.write_with_tag(50, |w| w.write_string(&**&self.display_name))?; }
        if self.initials != "" { w.write_with_tag(58, |w| w.write_string(&**&self.initials))?; }
        if self.color != "" { w.write_with_tag(66, |w| w.write_string(&**&self.color))?; }
        ...
        if self.cache_id != "" { w.write_with_tag(122, |w| w.write_string(&**&self.cache_id))?; }
        if self.bio != "" { w.write_with_tag(130, |w| w.write_string(&**&self.bio))?; }
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct RegisteredUserOwnedInner {
                buf: Vec<u8>,
                proto: RegisteredUser<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl RegisteredUserOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = RegisteredUser::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, RegisteredUser<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct RegisteredUserOwned {
                inner: core::pin::Pin<Box<RegisteredUserOwnedInner>>,
            }

            #[allow(dead_code)]
            impl RegisteredUserOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &RegisteredUser {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RegisteredUserOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RegisteredUserOwned {
                type Target = RegisteredUser<'static>;
            ...
            impl DerefMut for RegisteredUserOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RegisteredUserOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RegisteredUserOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<RegisteredUser<'a>> for RegisteredUserOwned {
                fn from(proto: RegisteredUser) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RegisteredUserOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct Avatar<'a> {
    pub id: u64,
    pub file: Option<proto::File<'a>>,
}

impl<'a> MessageRead<'a> for Avatar<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for Avatar<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.id == 0u64 { 0 } else { 1 + sizeof_varint(*(&self.id) as u64) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct AvatarOwnedInner {
                buf: Vec<u8>,
                proto: Avatar<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl AvatarOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = Avatar::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, Avatar<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct AvatarOwned {
                inner: core::pin::Pin<Box<AvatarOwnedInner>>,
            }
            ...
            impl AvatarOwned {
                ...
                pub fn proto(&self) -> &Avatar {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for AvatarOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for AvatarOwned {
                type Target = Avatar<'static>;
            ...
            impl DerefMut for AvatarOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for AvatarOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: AvatarOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<Avatar<'a>> for AvatarOwned {
                fn from(proto: Avatar) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: AvatarOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct RoomMessage<'a> {
    ...
    pub attachment: Option<proto::File<'a>>,
    pub author: Option<Box<proto::mod_RoomMessage::Author<'a>>>,
    pub location: Option<proto::RoomMessageLocation>,
    pub log: Option<proto::RoomMessageLog>,
    pub contact: Option<proto::RoomMessageContact<'a>>,
    pub wallet: Option<proto::RoomMessageWallet<'a>>,
    pub edited: bool,
    pub create_time: u32,
    pub update_time: u32,
    pub deleted: bool,
    pub forward_from: Option<Box<proto::RoomMessage<'a>>>,
    pub reply_to: Option<Box<proto::RoomMessage<'a>>>,
    pub previous_message_id: u64,
    pub random_id: u64,
    pub additional_type: u32,
    pub additional_data: Cow<'a, str>,
    pub extra_type: proto::mod_RoomMessage::ExtraType,
    pub channel_extra: Option<proto::mod_RoomMessage::ChannelExtra<'a>>,
}

impl<'a> MessageRead<'a> for RoomMessage<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(194) => msg.additional_data = r.read_string(bytes).map(Cow::Borrowed)?,
...
impl<'a> MessageWrite for RoomMessage<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.message_id == 0u64 { 0 } else { 1 + sizeof_varint(*(&self.message_id) as u64) }
        ...
        + if self.additional_data == "" { 0 } else { 2 + sizeof_len((&self.additional_data).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.additional_data != "" { w.write_with_tag(194, |w| w.write_string(&**&self.additional_data))?; }
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct RoomMessageOwnedInner {
                buf: Vec<u8>,
                proto: RoomMessage<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl RoomMessageOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = RoomMessage::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, RoomMessage<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct RoomMessageOwned {
                inner: core::pin::Pin<Box<RoomMessageOwnedInner>>,
            }

            #[allow(dead_code)]
            impl RoomMessageOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &RoomMessage {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RoomMessageOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RoomMessageOwned {
                type Target = RoomMessage<'static>;
            ...
            impl DerefMut for RoomMessageOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RoomMessageOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RoomMessageOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<RoomMessage<'a>> for RoomMessageOwned {
                fn from(proto: RoomMessage) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RoomMessageOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct Author<'a> {
    pub hash: Cow<'a, str>,
    pub user: Option<proto::mod_RoomMessage::mod_Author::User<'a>>,
    pub room: Option<Box<proto::Room<'a>>>,
}

impl<'a> MessageRead<'a> for Author<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for Author<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct AuthorOwnedInner {
                buf: Vec<u8>,
                proto: Author<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl AuthorOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = Author::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, Author<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct AuthorOwned {
                inner: core::pin::Pin<Box<AuthorOwnedInner>>,
            }
            ...
            impl AuthorOwned {
                ...
                pub fn proto(&self) -> &Author {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for AuthorOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for AuthorOwned {
                type Target = Author<'static>;
            ...
            impl DerefMut for AuthorOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for AuthorOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: AuthorOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<Author<'a>> for AuthorOwned {
                fn from(proto: Author) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: AuthorOwnedInner::new(buf).unwrap() }
                }
            }
    ...
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        ...
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(18) => msg.cache_id = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for User<'a> {
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.cache_id != "" { w.write_with_tag(18, |w| w.write_string(&**&self.cache_id))?; }
        Ok(())
    }
}
            ...
            impl UserOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = User::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, User<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct UserOwned {
                inner: core::pin::Pin<Box<UserOwnedInner>>,
            }
            ...
            impl UserOwned {
                ...
                pub fn proto(&self) -> &User {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for UserOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for UserOwned {
                type Target = User<'static>;
            ...
            impl DerefMut for UserOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for UserOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: UserOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<User<'a>> for UserOwned {
                fn from(proto: User) -> Self {
                    ...
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: UserOwnedInner::new(buf).unwrap() }
                }
            }
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct ChannelExtra<'a> {
    pub signature: Cow<'a, str>,
    pub views_label: Cow<'a, str>,
    pub thumbs_up_label: Cow<'a, str>,
    pub thumbs_down_label: Cow<'a, str>,
}

impl<'a> MessageRead<'a> for ChannelExtra<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.signature = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(18) => msg.views_label = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(26) => msg.thumbs_up_label = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(34) => msg.thumbs_down_label = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for ChannelExtra<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.signature == "" { 0 } else { 1 + sizeof_len((&self.signature).len()) }
        + if self.views_label == "" { 0 } else { 1 + sizeof_len((&self.views_label).len()) }
        + if self.thumbs_up_label == "" { 0 } else { 1 + sizeof_len((&self.thumbs_up_label).len()) }
        + if self.thumbs_down_label == "" { 0 } else { 1 + sizeof_len((&self.thumbs_down_label).len()) }
    }

    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        if self.signature != "" { w.write_with_tag(10, |w| w.write_string(&**&self.signature))?; }
        if self.views_label != "" { w.write_with_tag(18, |w| w.write_string(&**&self.views_label))?; }
        if self.thumbs_up_label != "" { w.write_with_tag(26, |w| w.write_string(&**&self.thumbs_up_label))?; }
        if self.thumbs_down_label != "" { w.write_with_tag(34, |w| w.write_string(&**&self.thumbs_down_label))?; }
        Ok(())
    }
}
            ...
            #[derive(Debug)]
            struct ChannelExtraOwnedInner {
                buf: Vec<u8>,
                proto: ChannelExtra<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl ChannelExtraOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = ChannelExtra::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, ChannelExtra<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct ChannelExtraOwned {
                inner: core::pin::Pin<Box<ChannelExtraOwnedInner>>,
            }

            #[allow(dead_code)]
            impl ChannelExtraOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &ChannelExtra {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for ChannelExtraOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for ChannelExtraOwned {
                type Target = ChannelExtra<'static>;
            ...
            impl DerefMut for ChannelExtraOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for ChannelExtraOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: ChannelExtraOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<ChannelExtra<'a>> for ChannelExtraOwned {
                fn from(proto: ChannelExtra) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: ChannelExtraOwnedInner::new(buf).unwrap() }
                }
            }
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct RoomDraft<'a> {
    pub message: Cow<'a, str>,
    pub reply_to: u64,
}

impl<'a> MessageRead<'a> for RoomDraft<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for RoomDraft<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.message == "" { 0 } else { 1 + sizeof_len((&self.message).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct RoomDraftOwnedInner {
                buf: Vec<u8>,
                proto: RoomDraft<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl RoomDraftOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = RoomDraft::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, RoomDraft<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct RoomDraftOwned {
                inner: core::pin::Pin<Box<RoomDraftOwnedInner>>,
            }
            ...
            impl RoomDraftOwned {
                ...
                pub fn proto(&self) -> &RoomDraft {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RoomDraftOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RoomDraftOwned {
                type Target = RoomDraft<'static>;
            ...
            impl DerefMut for RoomDraftOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RoomDraftOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RoomDraftOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<RoomDraft<'a>> for RoomDraftOwned {
                fn from(proto: RoomDraft) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RoomDraftOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct Room<'a> {
    ...
    pub last_message: Option<Box<proto::RoomMessage<'a>>>,
    pub read_only: bool,
    pub is_participant: bool,
    pub draft: Option<proto::RoomDraft<'a>>,
    pub first_unread_message: Option<Box<proto::RoomMessage<'a>>>,
    pub room_mute: proto::RoomMute,
    pub pin_id: u64,
    pub pinned_message: Option<Box<proto::RoomMessage<'a>>>,
    pub priority: u32,
    pub chat_room_extra: Option<proto::ChatRoom<'a>>,
    pub group_room_extra: Option<proto::GroupRoom<'a>>,
    pub channel_room_extra: Option<proto::ChannelRoom<'a>>,
}

impl<'a> MessageRead<'a> for Room<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(34) => msg.initials = r.read_string(bytes).map(Cow::Borrowed)?,
...
impl<'a> MessageWrite for Room<'a> {
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.initials != "" { w.write_with_tag(34, |w| w.write_string(&**&self.initials))?; }
        ...
        Ok(())
            ...
            impl RoomOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = Room::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, Room<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct RoomOwned {
                inner: core::pin::Pin<Box<RoomOwnedInner>>,
            }
            ...
            impl RoomOwned {
                ...
                pub fn proto(&self) -> &Room {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for RoomOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for RoomOwned {
                type Target = Room<'static>;
            ...
            impl DerefMut for RoomOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for RoomOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: RoomOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<Room<'a>> for RoomOwned {
                fn from(proto: Room) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: RoomOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct ChatRoom<'a> {
    pub peer: Option<proto::RegisteredUser<'a>>,
}

impl<'a> MessageRead<'a> for ChatRoom<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for ChatRoom<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct ChatRoomOwnedInner {
                buf: Vec<u8>,
                proto: ChatRoom<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl ChatRoomOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = ChatRoom::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, ChatRoom<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct ChatRoomOwned {
                inner: core::pin::Pin<Box<ChatRoomOwnedInner>>,
            }
            ...
            impl ChatRoomOwned {
                ...
                pub fn proto(&self) -> &ChatRoom {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for ChatRoomOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for ChatRoomOwned {
                type Target = ChatRoom<'static>;
            ...
            impl DerefMut for ChatRoomOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for ChatRoomOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: ChatRoomOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<ChatRoom<'a>> for ChatRoomOwned {
                fn from(proto: ChatRoom) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: ChatRoomOwnedInner::new(buf).unwrap() }
                }
            }
            
#[derive(Debug, Default, PartialEq, Clone)]
pub struct GroupRoom<'a> {
    pub type_pb: proto::mod_GroupRoom::Type,
    pub role: proto::mod_GroupRoom::Role,
    pub participants_count: u32,
    pub participants_count_label: Cow<'a, str>,
    pub participants_count_limit: u32,
    pub participants_count_limit_label: Cow<'a, str>,
    pub description: Cow<'a, str>,
    pub avatar_count: u32,
    pub avatar: Option<proto::Avatar<'a>>,
    pub private_extra: Option<proto::mod_GroupRoom::PrivateExtra<'a>>,
    pub public_extra: Option<proto::mod_GroupRoom::PublicExtra<'a>>,
}

impl<'a> MessageRead<'a> for GroupRoom<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(34) => msg.participants_count_label = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(40) => msg.participants_count_limit = r.read_uint32(bytes)?,
                Ok(50) => msg.participants_count_limit_label = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(58) => msg.description = r.read_string(bytes).map(Cow::Borrowed)?,
...
impl<'a> MessageWrite for GroupRoom<'a> {
    fn get_size(&self) -> usize {
        0
        ...
        + if self.participants_count_label == "" { 0 } else { 1 + sizeof_len((&self.participants_count_label).len()) }
        + if self.participants_count_limit == 0u32 { 0 } else { 1 + sizeof_varint(*(&self.participants_count_limit) as u64) }
        + if self.participants_count_limit_label == "" { 0 } else { 1 + sizeof_len((&self.participants_count_limit_label).len()) }
        + if self.description == "" { 0 } else { 1 + sizeof_len((&self.description).len()) }
        + if self.avatar_count == 0u32 { 0 } else { 1 + sizeof_varint(*(&self.avatar_count) as u64) }
        + self.avatar.as_ref().map_or(0, |m| 1 + sizeof_len((m).get_size()))
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.participants_count_label != "" { w.write_with_tag(34, |w| w.write_string(&**&self.participants_count_label))?; }
        if self.participants_count_limit != 0u32 { w.write_with_tag(40, |w| w.write_uint32(*&self.participants_count_limit))?; }
        if self.participants_count_limit_label != "" { w.write_with_tag(50, |w| w.write_string(&**&self.participants_count_limit_label))?; }
        if self.description != "" { w.write_with_tag(58, |w| w.write_string(&**&self.description))?; }
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct GroupRoomOwnedInner {
                buf: Vec<u8>,
                proto: GroupRoom<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl GroupRoomOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = GroupRoom::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, GroupRoom<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct GroupRoomOwned {
                inner: core::pin::Pin<Box<GroupRoomOwnedInner>>,
            }
            ...
            impl GroupRoomOwned {
                ...
                pub fn proto(&self) -> &GroupRoom {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for GroupRoomOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for GroupRoomOwned {
                type Target = GroupRoom<'static>;
            ...
            impl DerefMut for GroupRoomOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for GroupRoomOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: GroupRoomOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<GroupRoom<'a>> for GroupRoomOwned {
                fn from(proto: GroupRoom) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: GroupRoomOwnedInner::new(buf).unwrap() }
                }
            }
...
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PrivateExtra<'a> {
    pub invite_link: Cow<'a, str>,
    pub invite_token: Cow<'a, str>,
}

impl<'a> MessageRead<'a> for PrivateExtra<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.invite_link = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(18) => msg.invite_token = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for PrivateExtra<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.invite_link == "" { 0 } else { 1 + sizeof_len((&self.invite_link).len()) }
        + if self.invite_token == "" { 0 } else { 1 + sizeof_len((&self.invite_token).len()) }
    }

    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        if self.invite_link != "" { w.write_with_tag(10, |w| w.write_string(&**&self.invite_link))?; }
        if self.invite_token != "" { w.write_with_tag(18, |w| w.write_string(&**&self.invite_token))?; }
        Ok(())
    }
}
            ...
            #[derive(Debug)]
            struct PrivateExtraOwnedInner {
                buf: Vec<u8>,
                proto: PrivateExtra<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl PrivateExtraOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = PrivateExtra::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, PrivateExtra<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct PrivateExtraOwned {
                inner: core::pin::Pin<Box<PrivateExtraOwnedInner>>,
            }

            #[allow(dead_code)]
            impl PrivateExtraOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &PrivateExtra {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for PrivateExtraOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for PrivateExtraOwned {
                type Target = PrivateExtra<'static>;
            ...
            impl DerefMut for PrivateExtraOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for PrivateExtraOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: PrivateExtraOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<PrivateExtra<'a>> for PrivateExtraOwned {
                fn from(proto: PrivateExtra) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: PrivateExtraOwnedInner::new(buf).unwrap() }
                }
            }
            
#[derive(Debug, Default, PartialEq, Clone)]
pub struct PublicExtra<'a> {
    pub username: Cow<'a, str>,
}

impl<'a> MessageRead<'a> for PublicExtra<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for PublicExtra<'a> {
    fn get_size(&self) -> usize {
        0
        + if self.username == "" { 0 } else { 1 + sizeof_len((&self.username).len()) }
    }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct PublicExtraOwnedInner {
                buf: Vec<u8>,
                proto: PublicExtra<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl PublicExtraOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = PublicExtra::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, PublicExtra<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct PublicExtraOwned {
                inner: core::pin::Pin<Box<PublicExtraOwnedInner>>,
            }

            #[allow(dead_code)]
            impl PublicExtraOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &PublicExtra {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for PublicExtraOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for PublicExtraOwned {
                type Target = PublicExtra<'static>;
            ...
            impl DerefMut for PublicExtraOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for PublicExtraOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: PublicExtraOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<PublicExtra<'a>> for PublicExtraOwned {
                fn from(proto: PublicExtra) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: PublicExtraOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct ChannelRoom<'a> {
    ...
    pub avatar_count: u32,
    pub avatar: Option<proto::Avatar<'a>>,
    pub private_extra: Option<proto::mod_ChannelRoom::PrivateExtra<'a>>,
    pub public_extra: Option<proto::mod_ChannelRoom::PublicExtra<'a>>,
    pub signature: bool,
    pub seen_id: u64,
    pub verified: bool,
...
impl<'a> MessageRead<'a> for ChannelRoom<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
...
impl<'a> MessageWrite for ChannelRoom<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        Ok(())
            ...
            #[derive(Debug)]
            struct ChannelRoomOwnedInner {
                buf: Vec<u8>,
                proto: ChannelRoom<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl ChannelRoomOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = ChannelRoom::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, ChannelRoom<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct ChannelRoomOwned {
                inner: core::pin::Pin<Box<ChannelRoomOwnedInner>>,
            }

            #[allow(dead_code)]
            impl ChannelRoomOwned {
                pub fn buf(&self) -> &[u8] {
                    &self.inner.buf
                }

                pub fn proto(&self) -> &ChannelRoom {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for ChannelRoomOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for ChannelRoomOwned {
                type Target = ChannelRoom<'static>;
            ...
            impl DerefMut for ChannelRoomOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for ChannelRoomOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: ChannelRoomOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<ChannelRoom<'a>> for ChannelRoomOwned {
                fn from(proto: ChannelRoom) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: ChannelRoomOwnedInner::new(buf).unwrap() }
                }
            }
...
impl<'a> MessageRead<'a> for Thumbnail<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(34) => msg.cache_id = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(42) => msg.name = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(50) => msg.mime = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for Thumbnail<'a> {
    fn get_size(&self) -> usize {
        0
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.cache_id != "" { w.write_with_tag(34, |w| w.write_string(&**&self.cache_id))?; }
        if self.name != "" { w.write_with_tag(42, |w| w.write_string(&**&self.name))?; }
        if self.mime != "" { w.write_with_tag(50, |w| w.write_string(&**&self.mime))?; }
        Ok(())
    }
}
            ...
            #[derive(Debug)]
            struct ThumbnailOwnedInner {
                buf: Vec<u8>,
                proto: Thumbnail<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl ThumbnailOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = Thumbnail::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, Thumbnail<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct ThumbnailOwned {
                inner: core::pin::Pin<Box<ThumbnailOwnedInner>>,
            }
            ...
            impl ThumbnailOwned {
                ...
                pub fn proto(&self) -> &Thumbnail {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for ThumbnailOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for ThumbnailOwned {
                type Target = Thumbnail<'static>;
            ...
            impl DerefMut for ThumbnailOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for ThumbnailOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: ThumbnailOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<Thumbnail<'a>> for ThumbnailOwned {
                fn from(proto: Thumbnail) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: ThumbnailOwnedInner::new(buf).unwrap() }
                }
            }
...
pub struct File<'a> {
    ...
    pub name: Cow<'a, str>,
    pub size: i64,
    pub large_thumbnail: Option<proto::Thumbnail<'a>>,
    pub small_thumbnail: Option<proto::Thumbnail<'a>>,
    pub waveform_thumbnail: Option<proto::Thumbnail<'a>>,
    pub width: i32,
    pub height: i32,
    pub duration: f64,
    pub cache_id: Cow<'a, str>,
    pub mime: Cow<'a, str>,
    pub public_url: Cow<'a, str>,
}
    ...
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        ...
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(82) => msg.cache_id = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(90) => msg.mime = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(98) => msg.public_url = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for File<'a> {
    fn get_size(&self) -> usize {
        ...
        + if self.cache_id == "" { 0 } else { 1 + sizeof_len((&self.cache_id).len()) }
        + if self.mime == "" { 0 } else { 1 + sizeof_len((&self.mime).len()) }
        + if self.public_url == "" { 0 } else { 1 + sizeof_len((&self.public_url).len()) }
    }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.cache_id != "" { w.write_with_tag(82, |w| w.write_string(&**&self.cache_id))?; }
        if self.mime != "" { w.write_with_tag(90, |w| w.write_string(&**&self.mime))?; }
        if self.public_url != "" { w.write_with_tag(98, |w| w.write_string(&**&self.public_url))?; }
        Ok(())
    }
}
            ...
            impl FileOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    ...
                    unsafe {
                        let proto = core::mem::transmute::<_, File<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            #[cfg(feature = "test_helpers")]
            impl<'a> From<File<'a>> for FileOwned {
                fn from(proto: File) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: FileOwnedInner::new(buf).unwrap() }
                }
            }
...
impl<'a> MessageRead<'a> for Wallpaper<'a> {
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        let mut msg = Self::default();
        while !r.is_eof() {
            match r.next_tag(bytes) {
                Ok(10) => msg.file = Some(r.read_message::<proto::File>(bytes)?),
                Ok(18) => msg.color = r.read_string(bytes).map(Cow::Borrowed)?,
                Ok(t) => { r.read_unknown(bytes, t)?; }
                Err(e) => return Err(e),
            }
        }
...
impl<'a> MessageWrite for Wallpaper<'a> {
    fn get_size(&self) -> usize {
        0
        + self.file.as_ref().map_or(0, |m| 1 + sizeof_len((m).get_size()))
        + if self.color == "" { 0 } else { 1 + sizeof_len((&self.color).len()) }
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.color != "" { w.write_with_tag(18, |w| w.write_string(&**&self.color))?; }
        Ok(())
    }
}
            ...
            #[derive(Debug)]
            struct WallpaperOwnedInner {
                buf: Vec<u8>,
                proto: Wallpaper<'static>,
                _pin: core::marker::PhantomPinned,
            }

            impl WallpaperOwnedInner {
                fn new(buf: Vec<u8>) -> Result<core::pin::Pin<Box<Self>>> {
                    let inner = Self {
                        buf,
                        proto: unsafe { core::mem::MaybeUninit::zeroed().assume_init() },
                    ...
                    let mut reader = BytesReader::from_bytes(&pinned.buf);
                    let proto = Wallpaper::from_reader(&mut reader, &pinned.buf)?;

                    unsafe {
                        let proto = core::mem::transmute::<_, Wallpaper<'static>>(proto);
                        pinned.as_mut().get_unchecked_mut().proto = proto;
                    }
                    Ok(pinned)
                }
            ...
            pub struct WallpaperOwned {
                inner: core::pin::Pin<Box<WallpaperOwnedInner>>,
            }
            ...
            impl WallpaperOwned {
                ...
                pub fn proto(&self) -> &Wallpaper {
                    &self.inner.proto
                }
            }

            impl core::fmt::Debug for WallpaperOwned {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    self.inner.proto.fmt(f)
                }
            }

            impl Deref for WallpaperOwned {
                type Target = Wallpaper<'static>;
            ...
            impl DerefMut for WallpaperOwned {
                fn deref_mut(&mut self) -> &mut Self::Target {
                    unsafe { &mut self.inner.as_mut().get_unchecked_mut().proto }
                }
            }

            impl TryFrom<Vec<u8>> for WallpaperOwned {
                type Error=quick_protobuf::Error;

                fn try_from(buf: Vec<u8>) -> Result<Self> {
                    Ok(Self { inner: WallpaperOwnedInner::new(buf)? })
                }
            }

            #[cfg(feature = "test_helpers")]
            impl<'a> From<Wallpaper<'a>> for WallpaperOwned {
                fn from(proto: Wallpaper) -> Self {
                    use quick_protobuf::{MessageWrite, Writer};

                    let mut buf = Vec::new();
                    let mut writer = Writer::new(&mut buf);
                    proto.write_message(&mut writer).expect("bad proto serialization");
                    Self { inner: WallpaperOwnedInner::new(buf).unwrap() }
                }
            }
